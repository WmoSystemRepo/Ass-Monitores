...
namespace Sintetizador.DevHost
{
    /// <summary>
    /// Host POC do Monitor — NÃO faz parte do Windows Service original.
    /// Reutiliza ServWindows.StartDebug() já existente no DFEND_CTe_Sintetizador
    /// (o mesmo caminho usado quando o depurador está anexado), sem alterar o fonte original.
    ///
    /// Captura Debug.WriteLine do Sintetizador em monitor-live.log
    /// para o BFF exibir o fluxo em tempo real no painel.
    /// </summary>
    internal static class Program
    {
        private static void Main(string[] args)
        {
            ...
            WriteLive("DEVHOST", "Sintetizador.DevHost iniciando (host POC do monitor)");
        ...
        private static void InstallLiveTrace(string livePath)
        {
            try
            {
                ...
                // Debug.WriteLine do DFEND_CTe_Sintetizador (Threads.cs) cai aqui
