...
/** Conexão SignalR do monitor (não confundir com Arquivador ligado). */
...
export function arquivadorStatusLabel(scmStatus?: string | null, executar?: number | null): string {
...
export function summarizeLogMessage(mensagem?: string | null, cStat?: string | null): string {
  ...
  if (cStat === '118') return 'Documentos no ciclo de arquivamento (cStat 118)';
