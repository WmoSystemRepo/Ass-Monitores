...
public sealed class LocalDevOptions
{
    ...
    /// <summary>
    /// Opcional. Raiz do 0-Orquestrador (pasta com engines + Orquestrador.Api).
    /// Preferir deixar vazio: descoberta automatica a partir de Orquestrador.Api.
    /// Nunca grave path absoluto de outra maquina (C:\Users\...).
    /// </summary>
