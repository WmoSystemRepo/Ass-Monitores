...
namespace DFe
{
    class BdCTeAnalitico
    {
        ...
        public BdCTeAnalitico(string strConexao)
        {
        ...
        public int InserirLog(string strDescLog, string strCodServico)
        {
            ...
            try
            {
                ...
                stbSQL.Append(clsFacil.MontarQuery("INSERT INTO cte.log_analitico_conhecimento_transporte_eletronico "));
                stbSQL.Append(clsFacil.MontarQuery("( "));
                stbSQL.Append(clsFacil.MontarQuery("  des_log, "));
                stbSQL.Append(clsFacil.MontarQuery("  cod_servico_analitico_conhecimento_transporte_eletronico, "));
        ...
        public DataSet ObterServicos()
        {
            ...
            try
            {
                ...
                stbSQL.Append(clsFacil.MontarQuery("  c.seq_configuracao_analitico_conhecimento_transporte_eletronico as seq_configuracao, "));
                stbSQL.Append(clsFacil.MontarQuery("  c.cod_servico_analitico_conhecimento_transporte_eletronico as cod_servico, "));
                ...
                stbSQL.Append(clsFacil.MontarQuery("  cte.configuracao_analitico_conhecimento_transporte_eletronico c WITH (READPAST) "));
                stbSQL.Append(clsFacil.MontarQuery("  INNER JOIN cte.servico_analitico_conhecimento_transporte_eletronico s WITH (READPAST) "));
                stbSQL.Append(clsFacil.MontarQuery("  ON (c.cod_servico_analitico_conhecimento_transporte_eletronico = s.cod_servico_analitico_conhecimento_transporte_eletronico) "));
                string strSQL = stbSQL.ToString();
        ...
        public string ObterServico(string strCodServico)
        {
            ...
            try
            {
                ...
                stbSQL.Append(clsFacil.MontarQuery("  dtc_atualizacao "));
                stbSQL.Append(clsFacil.MontarQuery("FROM "));
                stbSQL.Append(clsFacil.MontarQuery("  cte.servico_analitico_conhecimento_transporte_eletronico WITH (READPAST) "));
                stbSQL.Append(clsFacil.MontarQuery("WHERE "));
                stbSQL.Append(clsFacil.MontarQuery("  cod_servico_analitico_conhecimento_transporte_eletronico = @cod_servico "));
                string strSQL = stbSQL.ToString();
        ...
        public int AtualizarServico(string strCodServico, string strServidor)
        {
            ...
            try
            {
                ...
                stbSQL.Append(clsFacil.MontarQuery("  cte.servico_analitico_conhecimento_transporte_eletronico "));
        ...
        public DataSet ObterConfiguracoes(string strCodServico, string strDescConfig, string strValorConfig, string strServidor)
        {
            ...
            try
            {
                ...
                {
                    stbSQL.Append(clsFacil.MontarQuery("  AND c.cod_servico_analitico_conhecimento_transporte_eletronico = @cod_servico "));
                }
        ...
        public string ObterConfiguracao(string strCodServico, string strDescConfig)
        {
            ...
            try
            {
                ...
                stbSQL.Append(clsFacil.MontarQuery("  dtc_atualizacao "));
                stbSQL.Append(clsFacil.MontarQuery("FROM "));
                stbSQL.Append(clsFacil.MontarQuery("  cte.configuracao_analitico_conhecimento_transporte_eletronico WITH (READPAST) "));
                stbSQL.Append(clsFacil.MontarQuery("WHERE "));
                stbSQL.Append(clsFacil.MontarQuery("  sts_ativo = 1 "));
                stbSQL.Append(clsFacil.MontarQuery("  AND cod_servico_analitico_conhecimento_transporte_eletronico = @cod_servico "));
        ...
        public int AtualizarConfiguracao(string strCodServico, string strDescConfig, string strValorConfig, string strAtivo)
        {
            ...
            try
            {
                // Montando query a ser executada
                stbSQL.Append(clsFacil.MontarQuery("UPDATE "));
                stbSQL.Append(clsFacil.MontarQuery("  cte.configuracao_analitico_conhecimento_transporte_eletronico "));
                stbSQL.Append(clsFacil.MontarQuery("SET "));
        ...
        #region " Insert CTe por Tabela "

        public int InserirXMLCTe_porTabela(Common.SerializableClasses.CTe.xmlCTe_v400_NT202402.proc CTe)
        {
            // Classes e variaveis utilizadas
            AcessoDados clsDados = new AcessoDados();
            Facilitador clsFacil = new Facilitador();
            string strSQL = string.Empty;
            ClsInserirCTe clsInserirCTe = new ClsInserirCTe();
            ...
            try
            {
                ...
                InserirXML_detalhe_xml_conhecimento_transporte_eletronico_autorizado(CTe);
                InserirXML_detalhe_xml_conhecimento_transporte_eletronico_autorizado_download(CTe);
                InserirXML_detalhe_xml_conhecimento_transporte_eletronico_fluxo_carga(CTe);
                InserirXML_detalhe_xml_conhecimento_transporte_eletronico_informacao_contribuinte(CTe);
                InserirXML_detalhe_xml_conhecimento_transporte_eletronico_informacao_fisco(CTe);
                InserirXML_detalhe_xml_conhecimento_transporte_eletronico_componente_prestacao(CTe);
                InserirXML_detalhe_xml_conhecimento_transporte_eletronico_carga(CTe);

                //infNF
                if (CTe.CteProc.CTe.infCte.infCTeNorm.infDoc.infNF.Count > 0)
                {
                    InserirXML_detalhe_xml_conhecimento_transporte_eletronico_nota_fiscal(CTe);
                    InserirXML_detalhe_xml_conhecimento_transporte_eletronico_unidade_carga_infNF(CTe);
                    InserirXML_detalhe_xml_conhecimento_transporte_eletronico_unidade_carga_lacre_infNF(CTe);
                    InserirXML_detalhe_xml_conhecimento_transporte_eletronico_unidade_transporte_infNF(CTe);
                    InserirXML_detalhe_xml_conhecimento_transporte_eletronico_unidade_transporte_lacre_infNF(CTe);
                    InserirXML_detalhe_xml_conhecimento_transporte_eletronico_unidade_transporte_unidade_carga_infNF(CTe);
                    InserirXML_detalhe_xml_conhecimento_transporte_eletronico_unidade_transporte_unidade_carga_lacre_infNF(CTe);
                }
                //infNFe
                if (CTe.CteProc.CTe.infCte.infCTeNorm.infDoc.infNFe.Count > 0)
                {
                    InserirXML_detalhe_xml_conhecimento_transporte_eletronico_nota_fiscal_eletronica(CTe);
                    InserirXML_detalhe_xml_conhecimento_transporte_eletronico_unidade_carga_infNFe(CTe);
                    InserirXML_detalhe_xml_conhecimento_transporte_eletronico_unidade_carga_lacre_infNFe(CTe);
                    InserirXML_detalhe_xml_conhecimento_transporte_eletronico_unidade_transporte_infNFe(CTe);
                    InserirXML_detalhe_xml_conhecimento_transporte_eletronico_unidade_transporte_lacre_infNFe(CTe);
                    InserirXML_detalhe_xml_conhecimento_transporte_eletronico_unidade_transporte_unidade_carga_infNFe(CTe);
                    InserirXML_detalhe_xml_conhecimento_transporte_eletronico_unidade_transporte_unidade_carga_lacre_infNFe(CTe);
                }
                //infOutros
                if (CTe.CteProc.CTe.infCte.infCTeNorm.infDoc.infOutros.Count > 0)
                {
                    InserirXML_detalhe_xml_conhecimento_transporte_eletronico_outro_documento(CTe);
                    InserirXML_detalhe_xml_conhecimento_transporte_eletronico_unidade_carga_infOutros(CTe);
                    InserirXML_detalhe_xml_conhecimento_transporte_eletronico_unidade_carga_lacre_infOutros(CTe);
                    InserirXML_detalhe_xml_conhecimento_transporte_eletronico_unidade_transporte_infOutros(CTe);
                    InserirXML_detalhe_xml_conhecimento_transporte_eletronico_unidade_transporte_lacre_infOutros(CTe);
                    InserirXML_detalhe_xml_conhecimento_transporte_eletronico_unidade_transporte_unidade_carga_infOutros(CTe);
                    InserirXML_detalhe_xml_conhecimento_transporte_eletronico_unidade_transporte_unidade_carga_lacre_infOutros(CTe);
                }

                InserirXML_detalhe_xml_conhecimento_transporte_eletronico_transporte_emissor_anterior(CTe);
                InserirXML_detalhe_xml_conhecimento_transporte_eletronico_transporte_anterior_papel(CTe);
                InserirXML_detalhe_xml_conhecimento_transporte_eletronico_transporte_anterior_eletronico(CTe);

                InserirXML_detalhe_xml_conhecimento_transporte_eletronico_veiculo(CTe);
                InserirXML_detalhe_xml_conhecimento_transporte_eletronico_cobranca_duplicata(CTe);
                InserirXML_detalhe_xml_conhecimento_transporte_eletronico_multimodal_vinculado(CTe);
                InserirXML_detalhe_xml_conhecimento_transporte_eletronico_complementado(CTe);

                if (CTe.CteProc.CTe.infCte.infCTeNorm.infModal.versaoModal != null)
                {
                    if (CTe.CteProc.CTe.infCte.ide.modal == "01")
                    {
                        InserirXML_detalhe_xml_conhecimento_transporte_eletronico_modal_rodoviario(CTe);
                    }
                    if (CTe.CteProc.CTe.infCte.ide.modal == "02")
                    {
                        InserirXML_detalhe_xml_conhecimento_transporte_eletronico_modal_aereo(CTe);
                        InserirXML_detalhe_xml_conhecimento_transporte_eletronico_modal_aereo_natureza_carga(CTe);
                        InserirXML_detalhe_xml_conhecimento_transporte_eletronico_modal_aereo_perigo_onu(CTe);
                    }
                    if (CTe.CteProc.CTe.infCte.ide.modal == "03")
                    {
                        InserirXML_detalhe_xml_conhecimento_transporte_eletronico_modal_aquaviario(CTe);
                        InserirXML_detalhe_xml_conhecimento_transporte_eletronico_modal_aquaviario_balsa(CTe);
                        InserirXML_detalhe_xml_conhecimento_transporte_eletronico_modal_aquaviario_conteiner(CTe);
                        InserirXML_detalhe_xml_conhecimento_transporte_eletronico_modal_aquaviario_conteiner_lacre(CTe);
                        InserirXML_detalhe_xml_conhecimento_transporte_eletronico_modal_aquaviario_nota_fiscal(CTe);
                        InserirXML_detalhe_xml_conhecimento_transporte_eletronico_modal_aquaviario_nota_fiscal_eletronica(CTe);
                    }
                    if (CTe.CteProc.CTe.infCte.ide.modal == "04")
                    {
                        InserirXML_detalhe_xml_conhecimento_transporte_eletronico_modal_ferroviario(CTe);
                        InserirXML_detalhe_xml_conhecimento_transporte_eletronico_modal_ferroviario_ferrovia(CTe);
                    }
                    if (CTe.CteProc.CTe.infCte.ide.modal == "05")
                    {
                        InserirXML_detalhe_xml_conhecimento_transporte_eletronico_modal_dutoviario(CTe);
                    }
                    if (CTe.CteProc.CTe.infCte.ide.modal == "06")
                    {
                        InserirXML_detalhe_xml_conhecimento_transporte_eletronico_modal_multimodal(CTe);
                    }
                }
            ...
            catch (Exception ex)
            {
                ...
                {
                    string y = "pegar o sql";
                }

                throw new ArgumentException($"[{strMetodo}]: " + " - chCTe: " + CTe.CteProc.protCTe.InfProt.chCTe + "." + ex.Message);
            }
            finally
            {
                clsDados = null;
        ...
        public int InserirXML_detalhe_xml_conhecimento_transporte_eletronico_autorizado(Common.SerializableClasses.CTe.xmlCTe_v400_NT202402.proc CTe)
        {
            // Classes e variaveis utilizadas
            AcessoDados clsDados = new AcessoDados();
            Facilitador clsFacil = new Facilitador();
            ...
            try
            {
                ...
                stbSQL.Append(clsFacil.MontarQuery("  ind_globalizado_conhecimento_transporte_eletronico, "));
                ...
                stbSQL.Append(clsFacil.MontarQuery("  ind_papel_tomador_prestacao_servico, "));
                ...
                stbSQL.Append(clsFacil.MontarQuery("  ind_cte_alteracao_tomador, "));
                stbSQL.Append(clsFacil.MontarQuery("  des_informacao_adicional, "));
                ...
                stbSQL.Append(clsFacil.MontarQuery("  des_campos_emisao_nff, "));
                stbSQL.Append(clsFacil.MontarQuery("  des_texto_qrcode_dacte, "));
                stbSQL.Append(clsFacil.MontarQuery("  dtc_atualizacao, "));
                ...
                stbSQL.Append(clsFacil.MontarQuery("  vlr_carga_averbacao, "));
                stbSQL.Append(clsFacil.MontarQuery("  cod_tipo_documento_transportado, "));
                ...
                clsFacil.AdicionarParametro(ref strSQL, CTe.CteProc.CTe.infCte.ide.indGlobalizado, "@ind_globalizado_conhecimento_transporte_eletronico", SqlDbType.SmallInt);
                ...
                clsFacil.AdicionarParametro(ref strSQL, CTe.CteProc.CTe.infCte.ide.indIEToma, "@ind_papel_tomador_prestacao_servico", SqlDbType.SmallInt);

                if (CTe.CteProc.CTe.infCte.ide.toma3.toma != null)
                {
                    clsFacil.AdicionarParametro(ref strSQL, CTe.CteProc.CTe.infCte.ide.toma3.toma, "@cod_tipo_servico_conhecimento_transporte_eletronico_tomador", SqlDbType.SmallInt);
                }
                ...
                if (CTe.CteProc.CTe.infCte.ide.toma4.CPF != null)
                {
                ...
                if (CTe.CteProc.CTe.infCte.ide.toma4.CNPJ != null)
                {
                ...
                //clsFacil.AdicionarParametro(ref strSQL, CTe.CteProc.CTe.infCte.compl.Entrega.comData.dProg.ToString("dd-MM-yyyy"), "@dtc_entrega_programada", SqlDbType.VarChar);
                ...
                if (CTe.CteProc.CTe.infCte.emit.CPF != null)
                {
                ...
                if (CTe.CteProc.CTe.infCte.emit.CNPJ != null)
                {
                ...
                clsFacil.AdicionarParametro(ref strSQL, CTe.CteProc.CTe.infCte.emit.IEST, "@num_insc_estad_substituto_tributario_emitente", SqlDbType.VarChar);
                ...
                clsFacil.AdicionarParametro(ref strSQL, CTe.CteProc.CTe.infCte.emit.CRT, "@cod_tipo_regime_tributario_emitente", SqlDbType.SmallInt);
                ...
                if (CTe.CteProc.CTe.infCte.rem.CPF != null)
                {
                ...
                if (CTe.CteProc.CTe.infCte.rem.CNPJ != null)
                {
                ...
                if (CTe.CteProc.CTe.infCte.exped.CPF != null)
                {
                ...
                if (CTe.CteProc.CTe.infCte.exped.CNPJ != null)
                {
                ...
                if (CTe.CteProc.CTe.infCte.receb.CPF != null)
                {
                ...
                if (CTe.CteProc.CTe.infCte.receb.CNPJ != null)
                {
                ...
                if (CTe.CteProc.CTe.infCte.dest.CPF != null)
                {
                ...
                if (CTe.CteProc.CTe.infCte.dest.CNPJ != null)
                {
                ...
                if (CTe.CteProc.CTe.infCte.imp.ICMS.ICMS20.CST != null)
                {
                    ...
                    vICMSDeson = Convert.ToString(CTe.CteProc.CTe.infCte.imp.ICMS.ICMS20.vICMSDeson);
                    cBenef = Convert.ToString(CTe.CteProc.CTe.infCte.imp.ICMS.ICMS20.cBenef);
                }
                if (CTe.CteProc.CTe.infCte.imp.ICMS.ICMS45.CST != null)
                {
                    CST = CTe.CteProc.CTe.infCte.imp.ICMS.ICMS45.CST;
                    vICMSDeson = Convert.ToString(CTe.CteProc.CTe.infCte.imp.ICMS.ICMS45.vICMSDeson);
                    cBenef = CTe.CteProc.CTe.infCte.imp.ICMS.ICMS45.cBenef;
                }
                if (CTe.CteProc.CTe.infCte.imp.ICMS.ICMS60.CST != null)
                {
                    CST = CTe.CteProc.CTe.infCte.imp.ICMS.ICMS60.CST;
                    vICMSDeson = Convert.ToString(CTe.CteProc.CTe.infCte.imp.ICMS.ICMS60.vICMSDeson);
                    cBenef = Convert.ToString(CTe.CteProc.CTe.infCte.imp.ICMS.ICMS60.cBenef);
                }
                if (CTe.CteProc.CTe.infCte.imp.ICMS.ICMS90.CST != null)
                {
                    CST = CTe.CteProc.CTe.infCte.imp.ICMS.ICMS90.CST;
                    vICMSDeson = Convert.ToString(CTe.CteProc.CTe.infCte.imp.ICMS.ICMS90.vICMSDeson);
                    cBenef = Convert.ToString(CTe.CteProc.CTe.infCte.imp.ICMS.ICMS90.cBenef);
                }
                if (CTe.CteProc.CTe.infCte.imp.ICMS.ICMSOutraUF.CST != null)
                {
                    CST = CTe.CteProc.CTe.infCte.imp.ICMS.ICMSOutraUF.CST;
                    vICMSDeson = Convert.ToString(CTe.CteProc.CTe.infCte.imp.ICMS.ICMSOutraUF.vICMSDeson);
                    cBenef = CTe.CteProc.CTe.infCte.imp.ICMS.ICMSOutraUF.cBenef;
                }
                if (CTe.CteProc.CTe.infCte.imp.ICMS.ICMSSN.CST != null)
                {
                    CST = CTe.CteProc.CTe.infCte.imp.ICMS.ICMSSN.CST;
                }
                ...
                clsFacil.AdicionarParametro(ref strSQL, CTe.CteProc.CTe.infCte.infCTeNorm.infCTeSub.indAlteraToma, "@ind_cte_alteracao_tomador", SqlDbType.SmallInt);
                clsFacil.AdicionarParametro(ref strSQL, CTe.CteProc.CTe.infCte.infCTeNorm.infGlobalizado.xObs, "@des_informacao_adicional", SqlDbType.VarChar);
                ...
                if (CTe.CteProc.CTe.infCte.infRespTec.CNPJ != null)
                {
                    clsFacil.AdicionarParametro(ref strSQL, CTe.CteProc.CTe.infCte.infRespTec.CNPJ.Substring(0, 8), "@num_cnpj_cpf_base_responsavel_tecnico", SqlDbType.VarChar);
                    clsFacil.AdicionarParametro(ref strSQL, CTe.CteProc.CTe.infCte.infRespTec.CNPJ.Substring(8, 4), "@num_cnpj_cpf_filial_responsavel_tecnico", SqlDbType.VarChar);
                    clsFacil.AdicionarParametro(ref strSQL, CTe.CteProc.CTe.infCte.infRespTec.CNPJ.Substring(12, 2), "@dig_cnpj_cpf_responsavel_tecnico", SqlDbType.SmallInt);
                }
                clsFacil.AdicionarParametro(ref strSQL, CTe.CteProc.CTe.infCte.infRespTec.xContato, "@nom_contato_responsavel_tecnico", SqlDbType.VarChar);
                clsFacil.AdicionarParametro(ref strSQL, CTe.CteProc.CTe.infCte.infRespTec.email, "@nom_email__responsavel_tecnico", SqlDbType.VarChar);
                clsFacil.AdicionarParametro(ref strSQL, CTe.CteProc.CTe.infCte.infRespTec.fone, "@num_relefone_responsavel_tecnico", SqlDbType.VarChar);
                clsFacil.AdicionarParametro(ref strSQL, CTe.CteProc.CTe.infCte.infRespTec.idCSRT, "@num_codigo_seguranca_responsavel_tecnico", SqlDbType.VarChar);
                clsFacil.AdicionarParametro(ref strSQL, CTe.CteProc.CTe.infCte.infRespTec.hashCSRT, "@num_hash_token_codigo_seguranca_responsavel_tecnico", SqlDbType.VarChar);
                clsFacil.AdicionarParametro(ref strSQL, CTe.CteProc.CTe.infCte.infSolicNFF.xSolic, "@des_campos_emisao_nff", SqlDbType.VarChar);
                clsFacil.AdicionarParametro(ref strSQL, CTe.CteProc.CTe.infCTeSupl.qrCodCTe, "@des_texto_qrcode_dacte", SqlDbType.VarChar);
                ...
                clsFacil.AdicionarParametro(ref strSQL, Convert.ToString(CTe.CteProc.CTe.infCte.infCTeNorm.infCarga.vCargaAverb), "@vlr_carga_averbacao", SqlDbType.Decimal);

                clsFacil.AdicionarParametro(ref strSQL, string.Empty, "@cod_tipo_documento_transportado", SqlDbType.SmallInt);

                if (CTe.CteProc.CTe.infCte.infCTeNorm.infDoc.infNF.Count > 0)
                {
                    clsFacil.AdicionarParametro(ref strSQL, "1", "@cod_tipo_documento_transportado", SqlDbType.SmallInt);
                }
                if (CTe.CteProc.CTe.infCte.infCTeNorm.infDoc.infNFe.Count > 0)
                {
                    clsFacil.AdicionarParametro(ref strSQL, "2", "@cod_tipo_documento_transportado", SqlDbType.SmallInt);
                }
                if (CTe.CteProc.CTe.infCte.infCTeNorm.infDoc.infOutros.Count > 0)
                {
                    clsFacil.AdicionarParametro(ref strSQL, "3", "@cod_tipo_documento_transportado", SqlDbType.SmallInt);
                }
        ...
        public int InserirXML_detalhe_xml_conhecimento_transporte_eletronico_autorizado_download(Common.SerializableClasses.CTe.xmlCTe_v400_NT202402.proc CTe)
        {
            // Classes e variaveis utilizadas
            AcessoDados clsDados = new AcessoDados();
            Facilitador clsFacil = new Facilitador();
            ...
            try
            {
                ...
                for (Lcont = 0; Lcont <= CTe.CteProc.CTe.infCte.autXML.Count - 1; Lcont++)
                {
                    ...
                    if (CTe.CteProc.CTe.infCte.autXML[Lcont].CPF != null)
                    {
                    ...
                    if (CTe.CteProc.CTe.infCte.autXML[Lcont].CNPJ != null)
                    {
        ...
        public int InserirXML_detalhe_xml_conhecimento_transporte_eletronico_fluxo_carga(Common.SerializableClasses.CTe.xmlCTe_v400_NT202402.proc CTe)
        {
            // Classes e variaveis utilizadas
            AcessoDados clsDados = new AcessoDados();
            Facilitador clsFacil = new Facilitador();
        ...
        public int InserirXML_detalhe_xml_conhecimento_transporte_eletronico_informacao_contribuinte(Common.SerializableClasses.CTe.xmlCTe_v400_NT202402.proc CTe)
        {
            // Classes e variaveis utilizadas
            AcessoDados clsDados = new AcessoDados();
            Facilitador clsFacil = new Facilitador();
        ...
        public int InserirXML_detalhe_xml_conhecimento_transporte_eletronico_informacao_fisco(Common.SerializableClasses.CTe.xmlCTe_v400_NT202402.proc CTe)
        {
            // Classes e variaveis utilizadas
            AcessoDados clsDados = new AcessoDados();
            Facilitador clsFacil = new Facilitador();
        ...
        public int InserirXML_detalhe_xml_conhecimento_transporte_eletronico_componente_prestacao(Common.SerializableClasses.CTe.xmlCTe_v400_NT202402.proc CTe)
        {
            // Classes e variaveis utilizadas
            AcessoDados clsDados = new AcessoDados();
            Facilitador clsFacil = new Facilitador();
        ...
        public int InserirXML_detalhe_xml_conhecimento_transporte_eletronico_carga(Common.SerializableClasses.CTe.xmlCTe_v400_NT202402.proc CTe)
        {
            // Classes e variaveis utilizadas
            AcessoDados clsDados = new AcessoDados();
            Facilitador clsFacil = new Facilitador();
        ...
        public int InserirXML_detalhe_xml_conhecimento_transporte_eletronico_nota_fiscal(Common.SerializableClasses.CTe.xmlCTe_v400_NT202402.proc CTe)
        {
            // Classes e variaveis utilizadas
            AcessoDados clsDados = new AcessoDados();
            Facilitador clsFacil = new Facilitador();
            ...
            try
            {
                ...
                for (Lcont = 0; Lcont <= CTe.CteProc.CTe.infCte.infCTeNorm.infDoc.infNF.Count - 1; Lcont++)
                {
                    ...
                    stbSQL.Append(clsFacil.MontarQuery("  cod_cfop_operacao_predominante, "));
                    ...
                    clsFacil.AdicionarParametro(ref strSQL_aux, CTe.CteProc.CTe.infCte.infCTeNorm.infDoc.infNF[Lcont].nCFOP, "@cod_cfop_operacao_predominante", SqlDbType.SmallInt);
        ...
        public int InserirXML_detalhe_xml_conhecimento_transporte_eletronico_unidade_carga_infNF(Common.SerializableClasses.CTe.xmlCTe_v400_NT202402.proc CTe)
        {
            // Classes e variaveis utilizadas
            AcessoDados clsDados = new AcessoDados();
            Facilitador clsFacil = new Facilitador();
        ...
        public int InserirXML_detalhe_xml_conhecimento_transporte_eletronico_unidade_carga_lacre_infNF(Common.SerializableClasses.CTe.xmlCTe_v400_NT202402.proc CTe)
        {
            // Classes e variaveis utilizadas
            AcessoDados clsDados = new AcessoDados();
            Facilitador clsFacil = new Facilitador();
        ...
        public int InserirXML_detalhe_xml_conhecimento_transporte_eletronico_unidade_transporte_infNF(Common.SerializableClasses.CTe.xmlCTe_v400_NT202402.proc CTe)
        {
            // Classes e variaveis utilizadas
            AcessoDados clsDados = new AcessoDados();
            Facilitador clsFacil = new Facilitador();
        ...
        public int InserirXML_detalhe_xml_conhecimento_transporte_eletronico_unidade_transporte_lacre_infNF(Common.SerializableClasses.CTe.xmlCTe_v400_NT202402.proc CTe)
        {
            // Classes e variaveis utilizadas
            AcessoDados clsDados = new AcessoDados();
            Facilitador clsFacil = new Facilitador();
        ...
        public int InserirXML_detalhe_xml_conhecimento_transporte_eletronico_unidade_transporte_unidade_carga_infNF(Common.SerializableClasses.CTe.xmlCTe_v400_NT202402.proc CTe)
        {
            // Classes e variaveis utilizadas
            AcessoDados clsDados = new AcessoDados();
            Facilitador clsFacil = new Facilitador();
        ...
        public int InserirXML_detalhe_xml_conhecimento_transporte_eletronico_unidade_transporte_unidade_carga_lacre_infNF(Common.SerializableClasses.CTe.xmlCTe_v400_NT202402.proc CTe)
        {
            // Classes e variaveis utilizadas
            AcessoDados clsDados = new AcessoDados();
            Facilitador clsFacil = new Facilitador();
        ...
        public int InserirXML_detalhe_xml_conhecimento_transporte_eletronico_nota_fiscal_eletronica(Common.SerializableClasses.CTe.xmlCTe_v400_NT202402.proc CTe)
        {
            // Classes e variaveis utilizadas
            AcessoDados clsDados = new AcessoDados();
            Facilitador clsFacil = new Facilitador();
        ...
        public int InserirXML_detalhe_xml_conhecimento_transporte_eletronico_unidade_carga_infNFe(Common.SerializableClasses.CTe.xmlCTe_v400_NT202402.proc CTe)
        {
            // Classes e variaveis utilizadas
            AcessoDados clsDados = new AcessoDados();
            Facilitador clsFacil = new Facilitador();
        ...
        public int InserirXML_detalhe_xml_conhecimento_transporte_eletronico_unidade_carga_lacre_infNFe(Common.SerializableClasses.CTe.xmlCTe_v400_NT202402.proc CTe)
        {
            // Classes e variaveis utilizadas
            AcessoDados clsDados = new AcessoDados();
            Facilitador clsFacil = new Facilitador();
        ...
        public int InserirXML_detalhe_xml_conhecimento_transporte_eletronico_unidade_transporte_infNFe(Common.SerializableClasses.CTe.xmlCTe_v400_NT202402.proc CTe)
        {
            // Classes e variaveis utilizadas
            AcessoDados clsDados = new AcessoDados();
            Facilitador clsFacil = new Facilitador();
        ...
        public int InserirXML_detalhe_xml_conhecimento_transporte_eletronico_unidade_transporte_lacre_infNFe(Common.SerializableClasses.CTe.xmlCTe_v400_NT202402.proc CTe)
        {
            // Classes e variaveis utilizadas
            AcessoDados clsDados = new AcessoDados();
            Facilitador clsFacil = new Facilitador();
        ...
        public int InserirXML_detalhe_xml_conhecimento_transporte_eletronico_unidade_transporte_unidade_carga_infNFe(Common.SerializableClasses.CTe.xmlCTe_v400_NT202402.proc CTe)
        {
            // Classes e variaveis utilizadas
            AcessoDados clsDados = new AcessoDados();
            Facilitador clsFacil = new Facilitador();
        ...
        public int InserirXML_detalhe_xml_conhecimento_transporte_eletronico_unidade_transporte_unidade_carga_lacre_infNFe(Common.SerializableClasses.CTe.xmlCTe_v400_NT202402.proc CTe)
        {
            // Classes e variaveis utilizadas
            AcessoDados clsDados = new AcessoDados();
            Facilitador clsFacil = new Facilitador();
        ...
        public int InserirXML_detalhe_xml_conhecimento_transporte_eletronico_outro_documento(Common.SerializableClasses.CTe.xmlCTe_v400_NT202402.proc CTe)
        {
            // Classes e variaveis utilizadas
            AcessoDados clsDados = new AcessoDados();
            Facilitador clsFacil = new Facilitador();
        ...
        public int InserirXML_detalhe_xml_conhecimento_transporte_eletronico_unidade_carga_infOutros(Common.SerializableClasses.CTe.xmlCTe_v400_NT202402.proc CTe)
        {
            // Classes e variaveis utilizadas
            AcessoDados clsDados = new AcessoDados();
            Facilitador clsFacil = new Facilitador();
        ...
        public int InserirXML_detalhe_xml_conhecimento_transporte_eletronico_unidade_carga_lacre_infOutros(Common.SerializableClasses.CTe.xmlCTe_v400_NT202402.proc CTe)
        {
            // Classes e variaveis utilizadas
            AcessoDados clsDados = new AcessoDados();
            Facilitador clsFacil = new Facilitador();
        ...
        public int InserirXML_detalhe_xml_conhecimento_transporte_eletronico_unidade_transporte_infOutros(Common.SerializableClasses.CTe.xmlCTe_v400_NT202402.proc CTe)
        {
            // Classes e variaveis utilizadas
            AcessoDados clsDados = new AcessoDados();
            Facilitador clsFacil = new Facilitador();
        ...
        public int InserirXML_detalhe_xml_conhecimento_transporte_eletronico_unidade_transporte_lacre_infOutros(Common.SerializableClasses.CTe.xmlCTe_v400_NT202402.proc CTe)
        {
            // Classes e variaveis utilizadas
            AcessoDados clsDados = new AcessoDados();
            Facilitador clsFacil = new Facilitador();
        ...
        public int InserirXML_detalhe_xml_conhecimento_transporte_eletronico_unidade_transporte_unidade_carga_infOutros(Common.SerializableClasses.CTe.xmlCTe_v400_NT202402.proc CTe)
        {
            // Classes e variaveis utilizadas
            AcessoDados clsDados = new AcessoDados();
            Facilitador clsFacil = new Facilitador();
        ...
        public int InserirXML_detalhe_xml_conhecimento_transporte_eletronico_unidade_transporte_unidade_carga_lacre_infOutros(Common.SerializableClasses.CTe.xmlCTe_v400_NT202402.proc CTe)
        {
            // Classes e variaveis utilizadas
            AcessoDados clsDados = new AcessoDados();
            Facilitador clsFacil = new Facilitador();
        ...
        public int InserirXML_detalhe_xml_conhecimento_transporte_eletronico_transporte_emissor_anterior(Common.SerializableClasses.CTe.xmlCTe_v400_NT202402.proc CTe)
        {
            // Classes e variaveis utilizadas
            AcessoDados clsDados = new AcessoDados();
            Facilitador clsFacil = new Facilitador();
            ...
            try
            {
                ...
                for (Lcont = 0; Lcont <= CTe.CteProc.CTe.infCte.infCTeNorm.docAnt.emiDocAnt.Count - 1; Lcont++)
                {
                    ...
                    if (CTe.CteProc.CTe.infCte.infCTeNorm.docAnt.emiDocAnt[Lcont].CPF != null)
                    {
        ...
        public int InserirXML_detalhe_xml_conhecimento_transporte_eletronico_transporte_anterior_papel(Common.SerializableClasses.CTe.xmlCTe_v400_NT202402.proc CTe)
        {
            // Classes e variaveis utilizadas
            AcessoDados clsDados = new AcessoDados();
            Facilitador clsFacil = new Facilitador();
        ...
        public int InserirXML_detalhe_xml_conhecimento_transporte_eletronico_transporte_anterior_eletronico(Common.SerializableClasses.CTe.xmlCTe_v400_NT202402.proc CTe)
        {
            // Classes e variaveis utilizadas
            AcessoDados clsDados = new AcessoDados();
            Facilitador clsFacil = new Facilitador();
                ...
                for (i = 0; i <= CTe.CteProc.CTe.infCte.infCTeNorm.docAnt.emiDocAnt.Count - 1; i++)
                {
                    ...
                    for (j = 0; j <= CTe.CteProc.CTe.infCte.infCTeNorm.docAnt.emiDocAnt[i].idDocAnt.Count - 1; j++)
                    {
                        ...
                        for (k = 0; k <= CTe.CteProc.CTe.infCte.infCTeNorm.docAnt.emiDocAnt[i].idDocAnt[j].idDocAntEle.Count - 1; k++)
                        {
                            ...
                            clsFacil.AdicionarParametro(ref strSQL_aux, Convert.ToString(i + 1), "@seq_detalhe_xml_conhecimento_transporte_eletronico_transporte_emissor_anterior", SqlDbType.SmallInt);
                            clsFacil.AdicionarParametro(ref strSQL_aux, Convert.ToString(j + 1), "@seq_informacao_identificacao_documento_transporte_anterior", SqlDbType.SmallInt);
                            clsFacil.AdicionarParametro(ref strSQL_aux, CTe.CteProc.CTe.infCte.infCTeNorm.docAnt.emiDocAnt[i].idDocAnt[j].idDocAntEle[k].chCTe, "@cod_chave_acesso_documento_transporte_anterior", SqlDbType.VarChar);
                            strSQL = strSQL + strSQL_aux;
                        }
                    }
                }
        ...
        public int InserirXML_detalhe_xml_conhecimento_transporte_eletronico_veiculo(Common.SerializableClasses.CTe.xmlCTe_v400_NT202402.proc CTe)
        {
            // Classes e variaveis utilizadas
            AcessoDados clsDados = new AcessoDados();
            Facilitador clsFacil = new Facilitador();
        ...
        public int InserirXML_detalhe_xml_conhecimento_transporte_eletronico_cobranca_duplicata(Common.SerializableClasses.CTe.xmlCTe_v400_NT202402.proc CTe)
        {
            // Classes e variaveis utilizadas
            AcessoDados clsDados = new AcessoDados();
            Facilitador clsFacil = new Facilitador();
            ...
            try
            {
                ...
                for (Lcont = 0; Lcont <= CTe.CteProc.CTe.infCte.infCTeNorm.cobr.dup.Count - 1; Lcont++)
                {
                    ...
                    stbSQL.Append(clsFacil.MontarQuery("  vlr_total_duplicata, "));
                    stbSQL.Append(clsFacil.MontarQuery("  dtc_atualizacao "));
                    stbSQL.Append(clsFacil.MontarQuery(") "));
                    stbSQL.Append(clsFacil.MontarQuery("VALUES "));
                    stbSQL.Append(clsFacil.MontarQuery("( "));
                    ...
                    clsFacil.AdicionarParametro(ref strSQL_aux, Convert.ToString(CTe.CteProc.CTe.infCte.infCTeNorm.cobr.dup[Lcont].vDup), "@vlr_total_duplicata", SqlDbType.Decimal);
        ...
        public int InserirXML_detalhe_xml_conhecimento_transporte_eletronico_multimodal_vinculado(Common.SerializableClasses.CTe.xmlCTe_v400_NT202402.proc CTe)
        {
            // Classes e variaveis utilizadas
            AcessoDados clsDados = new AcessoDados();
            Facilitador clsFacil = new Facilitador();
            ...
            try
            {
                ...
                int Lcont = 0;
                for (Lcont = 0; Lcont <= CTe.CteProc.CTe.infCte.infCTeNorm.infServVinc.infCTeMultimodal.Count - 1; Lcont++)
                {
                    strSQL_aux = string.Empty;
                    stbSQL.Clear();
                    // Montando query a ser executada
                    stbSQL.Append(clsFacil.MontarQuery("INSERT INTO cte.detalhe_xml_conhecimento_transporte_eletronico_multimodal_vinculado "));
                    stbSQL.Append(clsFacil.MontarQuery("( "));
                    stbSQL.Append(clsFacil.MontarQuery("  dtr_referencia, "));
                    stbSQL.Append(clsFacil.MontarQuery("  cod_chave_acesso, "));
                    stbSQL.Append(clsFacil.MontarQuery("  cod_chave_acesso_multimodal, "));
                    stbSQL.Append(clsFacil.MontarQuery("  dtc_atualizacao "));
                    stbSQL.Append(clsFacil.MontarQuery(") "));
                    stbSQL.Append(clsFacil.MontarQuery("VALUES "));
                    stbSQL.Append(clsFacil.MontarQuery("( "));
                    ...
                    clsFacil.AdicionarParametro(ref strSQL_aux, CTe.CteProc.CTe.infCte.infCTeNorm.infServVinc.infCTeMultimodal[Lcont].chCTeMultimodal, "@cod_chave_acesso_multimodal", SqlDbType.VarChar);
                    strSQL = strSQL + strSQL_aux;
                }
        ...
        public int InserirXML_detalhe_xml_conhecimento_transporte_eletronico_complementado(Common.SerializableClasses.CTe.xmlCTe_v400_NT202402.proc CTe)
        {
            // Classes e variaveis utilizadas
            AcessoDados clsDados = new AcessoDados();
            Facilitador clsFacil = new Facilitador();
            ...
            try
            {
                ...
                int Lcont = 0;
                for (Lcont = 0; Lcont <= CTe.CteProc.CTe.infCte.infCteComp.Count - 1; Lcont++)
                {
                    strSQL_aux = string.Empty;
                    stbSQL.Clear();
                    // Montando query a ser executada
                    ...
                    clsFacil.AdicionarParametro(ref strSQL_aux, CTe.CteProc.CTe.infCte.infCteComp[Lcont].chCTe, "@cod_chave_acesso_complementado", SqlDbType.VarChar);
                    strSQL = strSQL + strSQL_aux;
                }
        ...
        public int InserirXML_detalhe_xml_conhecimento_transporte_eletronico_modal_rodoviario(Common.SerializableClasses.CTe.xmlCTe_v400_NT202402.proc CTe)
        {
            // Classes e variaveis utilizadas
            AcessoDados clsDados = new AcessoDados();
            Facilitador clsFacil = new Facilitador();
            ...
            try
            {
                ...
                if (CTe.CteProc.CTe.infCte.infCTeNorm.infModal.rodo.occ.Count != 0)
                {
                    for (Lcont = 0; Lcont <= CTe.CteProc.CTe.infCte.infCTeNorm.infModal.rodo.occ.Count - 1; Lcont++)
                    {
                        ...
                        clsFacil.AdicionarParametro(ref strSQL_aux, Convert.ToString(CTe.CteProc.CTe.infCte.infCTeNorm.infModal.rodo.occ.Count), "@seq_detalhe_xml_conhecimento_transporte_eletronico_modal_rodoviario", SqlDbType.SmallInt);
                        ...
                        if (CTe.CteProc.CTe.infCte.infCTeNorm.infModal.rodo.occ[Lcont].emiOcc.CNPJ != null)
                        {
        ...
        public int InserirXML_detalhe_xml_conhecimento_transporte_eletronico_modal_aereo(Common.SerializableClasses.CTe.xmlCTe_v400_NT202402.proc CTe)
        {
            // Classes e variaveis utilizadas
            AcessoDados clsDados = new AcessoDados();
            Facilitador clsFacil = new Facilitador();
            ...
            try
            {
                ...
                stbSQL.Append(clsFacil.MontarQuery("  vlr_total_tarifa, "));
                stbSQL.Append(clsFacil.MontarQuery("  dtc_atualizacao "));
                stbSQL.Append(clsFacil.MontarQuery(") "));
                stbSQL.Append(clsFacil.MontarQuery("VALUES "));
                stbSQL.Append(clsFacil.MontarQuery("( "));
                ...
                clsFacil.AdicionarParametro(ref strSQL, Convert.ToString(CTe.CteProc.CTe.infCte.infCTeNorm.infModal.aereo.tarifa.vTar), "@vlr_total_tarifa", SqlDbType.Decimal);
        ...
        public int InserirXML_detalhe_xml_conhecimento_transporte_eletronico_modal_aereo_natureza_carga(Common.SerializableClasses.CTe.xmlCTe_v400_NT202402.proc CTe)
        {
            // Classes e variaveis utilizadas
            AcessoDados clsDados = new AcessoDados();
            Facilitador clsFacil = new Facilitador();
            ...
            try
            {
                ...
                for (Lcont = 0; Lcont <= CTe.CteProc.CTe.infCte.infCTeNorm.infModal.aereo.natCarga.cInfManu.Count - 1; Lcont++)
                {
                    ...
                    stbSQL.Append(clsFacil.MontarQuery("  des_dimesao, "));
                    ...
                    clsFacil.AdicionarParametro(ref strSQL_aux, "20" + CTe.CteProc.protCTe.InfProt.chCTe.Substring(2, 4), "@dtr_referencia", SqlDbType.Int);
                    clsFacil.AdicionarParametro(ref strSQL_aux, CTe.CteProc.protCTe.InfProt.chCTe, "@cod_chave_acesso", SqlDbType.VarChar);
                    clsFacil.AdicionarParametro(ref strSQL_aux, Convert.ToString(CTe.CteProc.CTe.infCte.infCTeNorm.infModal.aereo.natCarga.cInfManu.Count), "@seq_detalhe_xml_conhecimento_transporte_eletronico_modal_natureza_carga", SqlDbType.SmallInt);
                    clsFacil.AdicionarParametro(ref strSQL_aux, CTe.CteProc.CTe.infCte.infCTeNorm.infModal.aereo.natCarga.xDime, "@des_dimesao", SqlDbType.VarChar);
        ...
        public int InserirXML_detalhe_xml_conhecimento_transporte_eletronico_modal_aereo_perigo_onu(Common.SerializableClasses.CTe.xmlCTe_v400_NT202402.proc CTe)
        {
            // Classes e variaveis utilizadas
            AcessoDados clsDados = new AcessoDados();
            Facilitador clsFacil = new Facilitador();
            ...
            try
            {
                ...
                int Lcont = 0;
                for (Lcont = 0; Lcont <= CTe.CteProc.CTe.infCte.infCTeNorm.infModal.aereo.peri.Count - 1; Lcont++)
                {
                    strSQL_aux = string.Empty;
                    stbSQL.Clear();
                    // Montando query a ser executada
                    stbSQL.Append(clsFacil.MontarQuery("INSERT INTO cte.detalhe_xml_conhecimento_transporte_eletronico_modal_aereo_perigo_onu "));
                    stbSQL.Append(clsFacil.MontarQuery("( "));
                    stbSQL.Append(clsFacil.MontarQuery("  dtr_referencia, "));
                    stbSQL.Append(clsFacil.MontarQuery("  cod_chave_acesso, "));
                    stbSQL.Append(clsFacil.MontarQuery("  seq_detalhe_xml_conhecimento_transporte_eletronico_modal_aereo_perigo_onu, "));
                    ...
                    clsFacil.AdicionarParametro(ref strSQL_aux, "20" + CTe.CteProc.protCTe.InfProt.chCTe.Substring(2, 4), "@dtr_referencia", SqlDbType.Int);
                    clsFacil.AdicionarParametro(ref strSQL_aux, CTe.CteProc.protCTe.InfProt.chCTe, "@cod_chave_acesso", SqlDbType.VarChar);
                    clsFacil.AdicionarParametro(ref strSQL_aux, Convert.ToString(CTe.CteProc.CTe.infCte.infCTeNorm.infModal.aereo.peri.Count), "@seq_detalhe_xml_conhecimento_transporte_eletronico_modal_aereo_perigo_onu", SqlDbType.SmallInt);
                    clsFacil.AdicionarParametro(ref strSQL_aux, CTe.CteProc.CTe.infCte.infCTeNorm.infModal.aereo.peri[Lcont].nONU, "@num_onu", SqlDbType.VarChar);
                    clsFacil.AdicionarParametro(ref strSQL_aux, CTe.CteProc.CTe.infCte.infCTeNorm.infModal.aereo.peri[Lcont].qTotEmb, "@qtd_total_volume_perigoso", SqlDbType.VarChar);
                    clsFacil.AdicionarParametro(ref strSQL_aux, Convert.ToString(CTe.CteProc.CTe.infCte.infCTeNorm.infModal.aereo.peri[Lcont].infTotAP.qTotProd), "@qtd_total_artigo_perigoso", SqlDbType.Decimal);
                    clsFacil.AdicionarParametro(ref strSQL_aux, CTe.CteProc.CTe.infCte.infCTeNorm.infModal.aereo.peri[Lcont].infTotAP.uniAP, "@cod_tipo_unidade_medida", SqlDbType.SmallInt);
                    strSQL = strSQL + strSQL_aux;
                }
        ...
        public int InserirXML_detalhe_xml_conhecimento_transporte_eletronico_modal_multimodal(Common.SerializableClasses.CTe.xmlCTe_v400_NT202402.proc CTe)
        {
            // Classes e variaveis utilizadas
            AcessoDados clsDados = new AcessoDados();
            Facilitador clsFacil = new Facilitador();
            ...
            try
            {
                ...
                clsFacil.AdicionarParametro(ref strSQL, CTe.CteProc.CTe.infCte.infCTeNorm.infModal.multimodal.seg.infSeg.xSeg, "@nom_seguradora", SqlDbType.VarChar);
                ...
                if (CTe.CteProc.CTe.infCte.infCTeNorm.infModal.multimodal.seg.infSeg.CNPJ != null)
                {
                    clsFacil.AdicionarParametro(ref strSQL, CTe.CteProc.CTe.infCte.infCTeNorm.infModal.multimodal.seg.infSeg.CNPJ.Substring(0, 8), "@num_cnpj_cpf_base_seguradora", SqlDbType.VarChar);
                    clsFacil.AdicionarParametro(ref strSQL, CTe.CteProc.CTe.infCte.infCTeNorm.infModal.multimodal.seg.infSeg.CNPJ.Substring(8, 4), "@num_cnpj_cpf_filial_seguradora", SqlDbType.VarChar);
                    clsFacil.AdicionarParametro(ref strSQL, CTe.CteProc.CTe.infCte.infCTeNorm.infModal.multimodal.seg.infSeg.CNPJ.Substring(12, 2), "@dig_cnpj_cpf_seguradora", SqlDbType.SmallInt);
                }
                clsFacil.AdicionarParametro(ref strSQL, CTe.CteProc.CTe.infCte.infCTeNorm.infModal.multimodal.seg.nApol, "@num_apolice_seguro", SqlDbType.VarChar);
                clsFacil.AdicionarParametro(ref strSQL, CTe.CteProc.CTe.infCte.infCTeNorm.infModal.multimodal.seg.nAver, "@num_averbacao", SqlDbType.VarChar);
        ...
        public int InserirXML_detalhe_xml_conhecimento_transporte_eletronico_modal_ferroviario(Common.SerializableClasses.CTe.xmlCTe_v400_NT202402.proc CTe)
        {
            // Classes e variaveis utilizadas
            AcessoDados clsDados = new AcessoDados();
            Facilitador clsFacil = new Facilitador();
            ...
            try
            {
                ...
                stbSQL.Append(clsFacil.MontarQuery("  vlr_total_frete_trafego_mutuo, "));
                ...
                clsFacil.AdicionarParametro(ref strSQL, Convert.ToString(CTe.CteProc.CTe.infCte.infCTeNorm.infModal.ferrov.trafMut.vFrete), "@vlr_total_frete_trafego_mutuo", SqlDbType.Decimal);
                clsFacil.AdicionarParametro(ref strSQL, CTe.CteProc.CTe.infCte.infCTeNorm.infModal.ferrov.trafMut.chCTeFerroOrigem, "@cod_chave_acesso_cte_ferrovia", SqlDbType.VarChar);
                clsFacil.AdicionarParametro(ref strSQL, CTe.CteProc.CTe.infCte.infCTeNorm.infModal.ferrov.trafMut.fluxo, "@num_fluxo_ferroviario", SqlDbType.VarChar);
        ...
        public int InserirXML_detalhe_xml_conhecimento_transporte_eletronico_modal_ferroviario_ferrovia(Common.SerializableClasses.CTe.xmlCTe_v400_NT202402.proc CTe)
        {
            // Classes e variaveis utilizadas
            AcessoDados clsDados = new AcessoDados();
            Facilitador clsFacil = new Facilitador();
            ...
            try
            {
                ...
                int Lcont = 0;
                for (Lcont = 0; Lcont <= CTe.CteProc.CTe.infCte.infCTeNorm.infModal.ferrov.trafMut.ferroEnv.Count - 1; Lcont++)
                {
                    strSQL_aux = string.Empty;
                    stbSQL.Clear();
                    // Montando query a ser executada
                    ...
                    clsFacil.AdicionarParametro(ref strSQL_aux, "20" + CTe.CteProc.protCTe.InfProt.chCTe.Substring(2, 4), "@dtr_referencia", SqlDbType.Int);
                    clsFacil.AdicionarParametro(ref strSQL_aux, CTe.CteProc.protCTe.InfProt.chCTe, "@cod_chave_acesso", SqlDbType.VarChar);
                    clsFacil.AdicionarParametro(ref strSQL_aux, Convert.ToString(CTe.CteProc.CTe.infCte.infCTeNorm.infModal.ferrov.trafMut.ferroEnv.Count), "@seq_detalhe_xml_conhecimento_transporte_eletronico_modal_ferroviario_ferrovia", SqlDbType.SmallInt);
                    ...
                    if (CTe.CteProc.CTe.infCte.infCTeNorm.infModal.ferrov.trafMut.ferroEnv[Lcont].CNPJ != null)
                    {
                        clsFacil.AdicionarParametro(ref strSQL_aux, CTe.CteProc.CTe.infCte.infCTeNorm.infModal.ferrov.trafMut.ferroEnv[Lcont].CNPJ.Substring(0, 8), "@num_cnpj_cpf_base_ferrovia", SqlDbType.VarChar);
                        clsFacil.AdicionarParametro(ref strSQL_aux, CTe.CteProc.CTe.infCte.infCTeNorm.infModal.ferrov.trafMut.ferroEnv[Lcont].CNPJ.Substring(8, 4), "@num_cnpj_cpf_filial_ferrovia", SqlDbType.VarChar);
                        clsFacil.AdicionarParametro(ref strSQL_aux, CTe.CteProc.CTe.infCte.infCTeNorm.infModal.ferrov.trafMut.ferroEnv[Lcont].CNPJ.Substring(12, 2), "@dig_cnpj_cpf_ferrovia", SqlDbType.SmallInt);
                    }
                    clsFacil.AdicionarParametro(ref strSQL_aux, CTe.CteProc.CTe.infCte.infCTeNorm.infModal.ferrov.trafMut.ferroEnv[Lcont].cInt, "@cod_interno_ferrovia", SqlDbType.VarChar);
                    clsFacil.AdicionarParametro(ref strSQL_aux, CTe.CteProc.CTe.infCte.infCTeNorm.infModal.ferrov.trafMut.ferroEnv[Lcont].IE, "@num_insc_estad_ferrovia", SqlDbType.VarChar);
                    clsFacil.AdicionarParametro(ref strSQL_aux, CTe.CteProc.CTe.infCte.infCTeNorm.infModal.ferrov.trafMut.ferroEnv[Lcont].xNome, "@nom_razao_social_ferrovia", SqlDbType.VarChar);
                    clsFacil.AdicionarParametro(ref strSQL_aux, CTe.CteProc.CTe.infCte.infCTeNorm.infModal.ferrov.trafMut.ferroEnv[Lcont].enderFerro.xLgr, "@des_logradouro_ferrovia", SqlDbType.VarChar);
                    clsFacil.AdicionarParametro(ref strSQL_aux, CTe.CteProc.CTe.infCte.infCTeNorm.infModal.ferrov.trafMut.ferroEnv[Lcont].enderFerro.nro, "@num_endereco_ferrovia", SqlDbType.VarChar);
                    clsFacil.AdicionarParametro(ref strSQL_aux, CTe.CteProc.CTe.infCte.infCTeNorm.infModal.ferrov.trafMut.ferroEnv[Lcont].enderFerro.xCpl, "@des_compl_endereco_ferrovia", SqlDbType.VarChar);
                    clsFacil.AdicionarParametro(ref strSQL_aux, CTe.CteProc.CTe.infCte.infCTeNorm.infModal.ferrov.trafMut.ferroEnv[Lcont].enderFerro.xBairro, "@des_bairro_ferrovia", SqlDbType.VarChar);
                    clsFacil.AdicionarParametro(ref strSQL_aux, CTe.CteProc.CTe.infCte.infCTeNorm.infModal.ferrov.trafMut.ferroEnv[Lcont].enderFerro.cMun, "@cod_municipio_ibge_ferrovia", SqlDbType.Int);
                    clsFacil.AdicionarParametro(ref strSQL_aux, CTe.CteProc.CTe.infCte.infCTeNorm.infModal.ferrov.trafMut.ferroEnv[Lcont].enderFerro.xMun, "@nom_municipio_ibge_ferrovia", SqlDbType.VarChar);
                    clsFacil.AdicionarParametro(ref strSQL_aux, CTe.CteProc.CTe.infCte.infCTeNorm.infModal.ferrov.trafMut.ferroEnv[Lcont].enderFerro.CEP, "@num_cep_ferrovia", SqlDbType.Int);
                    clsFacil.AdicionarParametro(ref strSQL_aux, CTe.CteProc.CTe.infCte.infCTeNorm.infModal.ferrov.trafMut.ferroEnv[Lcont].enderFerro.UF, "@sig_unid_federacao_ferrovia", SqlDbType.VarChar);
                    strSQL = strSQL + strSQL_aux;
                }
        ...
        public int InserirXML_detalhe_xml_conhecimento_transporte_eletronico_modal_dutoviario(Common.SerializableClasses.CTe.xmlCTe_v400_NT202402.proc CTe)
        {
            // Classes e variaveis utilizadas
            AcessoDados clsDados = new AcessoDados();
            Facilitador clsFacil = new Facilitador();
            ...
            try
            {
                ...
                clsFacil.AdicionarParametro(ref strSQL, CTe.CteProc.protCTe.InfProt.chCTe, "@cod_chave_acesso", SqlDbType.VarChar);
                clsFacil.AdicionarParametro(ref strSQL, CTe.CteProc.CTe.infCte.infCTeNorm.infModal.versaoModal, "@des_versao_modal", SqlDbType.VarChar);
                clsFacil.AdicionarParametro(ref strSQL, Convert.ToString(CTe.CteProc.CTe.infCte.infCTeNorm.infModal.duto.vTar), "@vlr_total_tarifa", SqlDbType.Decimal);
        ...
        public int InserirXML_detalhe_xml_conhecimento_transporte_eletronico_modal_aquaviario(Common.SerializableClasses.CTe.xmlCTe_v400_NT202402.proc CTe)
        {
            // Classes e variaveis utilizadas
            AcessoDados clsDados = new AcessoDados();
            Facilitador clsFacil = new Facilitador();
            ...
            try
            {
                ...
                stbSQL.Append(clsFacil.MontarQuery("  vlr_total_base_calculo_prestacao_afrmn, "));
                stbSQL.Append(clsFacil.MontarQuery("  vlr_total_adicional_frete_afrmn, "));
                ...
                clsFacil.AdicionarParametro(ref strSQL, Convert.ToString(CTe.CteProc.CTe.infCte.infCTeNorm.infModal.aquav.vPrest), "@vlr_total_base_calculo_prestacao_afrmn", SqlDbType.Decimal);
                clsFacil.AdicionarParametro(ref strSQL, Convert.ToString(CTe.CteProc.CTe.infCte.infCTeNorm.infModal.aquav.vAFRMM), "@vlr_total_adicional_frete_afrmn", SqlDbType.Decimal);
        ...
        public int InserirXML_detalhe_xml_conhecimento_transporte_eletronico_modal_aquaviario_balsa(Common.SerializableClasses.CTe.xmlCTe_v400_NT202402.proc CTe)
        {
            // Classes e variaveis utilizadas
            AcessoDados clsDados = new AcessoDados();
            Facilitador clsFacil = new Facilitador();
            ...
            try
            {
                ...
                for (Lcont = 0; Lcont <= CTe.CteProc.CTe.infCte.infCTeNorm.infModal.aquav.balsa.Count - 1; Lcont++)
                {
                    ...
                    clsFacil.AdicionarParametro(ref strSQL_aux, "20" + CTe.CteProc.protCTe.InfProt.chCTe.Substring(2, 4), "@dtr_referencia", SqlDbType.Int);
                    clsFacil.AdicionarParametro(ref strSQL_aux, CTe.CteProc.protCTe.InfProt.chCTe, "@cod_chave_acesso", SqlDbType.VarChar);
                    clsFacil.AdicionarParametro(ref strSQL_aux, Convert.ToString(CTe.CteProc.CTe.infCte.infCTeNorm.infModal.aquav.balsa.Count), "@seq_detalhe_xml_conhecimento_transporte_eletronico_modal_aquaviario_balsa", SqlDbType.SmallInt);
        ...
        public int InserirXML_detalhe_xml_conhecimento_transporte_eletronico_modal_aquaviario_conteiner(Common.SerializableClasses.CTe.xmlCTe_v400_NT202402.proc CTe)
        {
            // Classes e variaveis utilizadas
            AcessoDados clsDados = new AcessoDados();
            Facilitador clsFacil = new Facilitador();
            ...
            try
            {
                ...
                for (Lcont = 0; Lcont <= CTe.CteProc.CTe.infCte.infCTeNorm.infModal.aquav.detCont.Count - 1; Lcont++)
                {
                    ...
                    clsFacil.AdicionarParametro(ref strSQL_aux, "20" + CTe.CteProc.protCTe.InfProt.chCTe.Substring(2, 4), "@dtr_referencia", SqlDbType.Int);
                    clsFacil.AdicionarParametro(ref strSQL_aux, CTe.CteProc.protCTe.InfProt.chCTe, "@cod_chave_acesso", SqlDbType.VarChar);
                    clsFacil.AdicionarParametro(ref strSQL_aux, Convert.ToString(CTe.CteProc.CTe.infCte.infCTeNorm.infModal.aquav.detCont.Count), "@seq_detalhe_xml_conhecimento_transporte_eletronico_modal_aquaviario_container", SqlDbType.SmallInt);
                    clsFacil.AdicionarParametro(ref strSQL_aux, CTe.CteProc.CTe.infCte.infCTeNorm.infModal.aquav.xNavio, "@num_identificacao_navio", SqlDbType.VarChar);
        ...
        public int InserirXML_detalhe_xml_conhecimento_transporte_eletronico_modal_aquaviario_conteiner_lacre(Common.SerializableClasses.CTe.xmlCTe_v400_NT202402.proc CTe)
        {
            // Classes e variaveis utilizadas
            AcessoDados clsDados = new AcessoDados();
            Facilitador clsFacil = new Facilitador();
            ...
            try
            {
                ...
                for (i = 0; i <= CTe.CteProc.CTe.infCte.infCTeNorm.infModal.aquav.detCont.Count - 1; i++)
                {
                    ...
                    for (j = 0; j <= CTe.CteProc.CTe.infCte.infCTeNorm.infModal.aquav.detCont[i].lacre.Count - 1; j++)
                    {
                        ...
                        clsFacil.AdicionarParametro(ref strSQL_aux, CTe.CteProc.protCTe.InfProt.chCTe, "@cod_chave_acesso", SqlDbType.VarChar);
                        clsFacil.AdicionarParametro(ref strSQL_aux, Convert.ToString(CTe.CteProc.CTe.infCte.infCTeNorm.infModal.aquav.detCont.Count), "@seq_detalhe_xml_conhecimento_transporte_eletronico_modal_aquaviario_container", SqlDbType.SmallInt);
                        clsFacil.AdicionarParametro(ref strSQL_aux, Convert.ToString(CTe.CteProc.CTe.infCte.infCTeNorm.infModal.aquav.detCont[i].lacre.Count), "@seq_detalhe_xml_conhecimento_transporte_eletronico_modal_aquaviario_container_lacre", SqlDbType.SmallInt);
                        clsFacil.AdicionarParametro(ref strSQL_aux, CTe.CteProc.CTe.infCte.infCTeNorm.infModal.aquav.xNavio, "@num_identificacao_navio", SqlDbType.VarChar);
        ...
        public int InserirXML_detalhe_xml_conhecimento_transporte_eletronico_modal_aquaviario_nota_fiscal(Common.SerializableClasses.CTe.xmlCTe_v400_NT202402.proc CTe)
        {
            // Classes e variaveis utilizadas
            AcessoDados clsDados = new AcessoDados();
            Facilitador clsFacil = new Facilitador();
            ...
            try
            {
                ...
                for (i = 0; i <= CTe.CteProc.CTe.infCte.infCTeNorm.infModal.aquav.detCont.Count - 1; i++)
                {
                    ...
                    for (j = 0; j <= CTe.CteProc.CTe.infCte.infCTeNorm.infModal.aquav.detCont[i].infDoc.infNF.Count - 1; j++)
                    {
                        ...
                        clsFacil.AdicionarParametro(ref strSQL_aux, "20" + CTe.CteProc.protCTe.InfProt.chCTe.Substring(2, 4), "@dtr_referencia", SqlDbType.Int);
                        clsFacil.AdicionarParametro(ref strSQL_aux, CTe.CteProc.protCTe.InfProt.chCTe, "@cod_chave_acesso", SqlDbType.VarChar);
                        clsFacil.AdicionarParametro(ref strSQL_aux, Convert.ToString(CTe.CteProc.CTe.infCte.infCTeNorm.infModal.aquav.detCont[i].infDoc.infNF.Count), "@seq_detalhe_xml_conhecimento_transporte_eletronico_modal_aquaviario_nota_fiscal", SqlDbType.SmallInt);
                        clsFacil.AdicionarParametro(ref strSQL_aux, CTe.CteProc.CTe.infCte.infCTeNorm.infModal.aquav.xNavio, "@num_identificacao_navio", SqlDbType.VarChar);
        ...
        public int InserirXML_detalhe_xml_conhecimento_transporte_eletronico_modal_aquaviario_nota_fiscal_eletronica(Common.SerializableClasses.CTe.xmlCTe_v400_NT202402.proc CTe)
        {
            // Classes e variaveis utilizadas
            AcessoDados clsDados = new AcessoDados();
            Facilitador clsFacil = new Facilitador();
            ...
            try
            {
                ...
                for (i = 0; i <= CTe.CteProc.CTe.infCte.infCTeNorm.infModal.aquav.detCont.Count - 1; i++)
                {
                    ...
                    for (j = 0; j <= CTe.CteProc.CTe.infCte.infCTeNorm.infModal.aquav.detCont[i].infDoc.infNFe.Count - 1; j++)
                    {
                        ...
                        stbSQL.Append(clsFacil.MontarQuery("  vlr_unidade_medida, "));
                        stbSQL.Append(clsFacil.MontarQuery("  dtc_atualizacao "));
                        stbSQL.Append(clsFacil.MontarQuery(") "));
                        stbSQL.Append(clsFacil.MontarQuery("VALUES "));
                        stbSQL.Append(clsFacil.MontarQuery("( "));
                        ...
                        clsFacil.AdicionarParametro(ref strSQL_aux, "20" + CTe.CteProc.protCTe.InfProt.chCTe.Substring(2, 4), "@dtr_referencia", SqlDbType.Int);
                        clsFacil.AdicionarParametro(ref strSQL_aux, CTe.CteProc.protCTe.InfProt.chCTe, "@cod_chave_acesso", SqlDbType.VarChar);
                        clsFacil.AdicionarParametro(ref strSQL_aux, Convert.ToString(CTe.CteProc.CTe.infCte.infCTeNorm.infModal.aquav.detCont[i].infDoc.infNFe.Count), "@seq_detalhe_xml_conhecimento_transporte_eletronico_modal_aquaviario_nota_fiscal_eletronica", SqlDbType.SmallInt);
                        clsFacil.AdicionarParametro(ref strSQL_aux, CTe.CteProc.CTe.infCte.infCTeNorm.infModal.aquav.xNavio, "@num_identificacao_navio", SqlDbType.VarChar);
                        ...
                        clsFacil.AdicionarParametro(ref strSQL_aux, Convert.ToString(CTe.CteProc.CTe.infCte.infCTeNorm.infModal.aquav.detCont[i].infDoc.infNFe[j].unidRat), "@vlr_unidade_medida", SqlDbType.Decimal);
                        strSQL = strSQL + strSQL_aux;
        ...
        #region " Inserir Chave de Acesso "

        public string Inserir_chave_acesso_esquema_conhecimento_transporte_eletronico(string Pcod_chave_acesso, string Pcod_tipo_esquema_conhecimento_transporte_eletronico)
        {
            // Classes e variaveis utilizadas
            AcessoDados clsDados = new AcessoDados();
            Facilitador clsFacil = new Facilitador();
            ...
            try
            {
                ...
                stbSQL.Append(clsFacil.MontarQuery("INSERT INTO cte.chave_acesso_esquema_conhecimento_transporte_eletronico "));
                stbSQL.Append(clsFacil.MontarQuery("( "));
                stbSQL.Append(clsFacil.MontarQuery("  dtr_referencia, "));
                stbSQL.Append(clsFacil.MontarQuery("  cod_chave_acesso, "));
                stbSQL.Append(clsFacil.MontarQuery("  cod_tipo_esquema_conhecimento_transporte_eletronico, "));
                stbSQL.Append(clsFacil.MontarQuery("  dtc_atualizacao "));
                stbSQL.Append(clsFacil.MontarQuery(") "));
                stbSQL.Append(clsFacil.MontarQuery("VALUES "));
                stbSQL.Append(clsFacil.MontarQuery("( "));
                ...
                // Montando parametros
                clsDados.LimparParametro();
                clsFacil.AdicionarParametro(ref strSQL, "20" + Pcod_chave_acesso.Substring(2, 4), "@dtr_referencia", SqlDbType.Int);
                clsFacil.AdicionarParametro(ref strSQL, Pcod_chave_acesso, "@cod_chave_acesso", SqlDbType.VarChar);
                clsFacil.AdicionarParametro(ref strSQL, Pcod_tipo_esquema_conhecimento_transporte_eletronico, "@cod_tipo_esquema_conhecimento_transporte_eletronico", SqlDbType.SmallInt);
            ...
            {
                clsDados.RollbackTransaction();
                throw new ArgumentException($"[{strMetodo}]: " + " - chCTe: " + Pcod_chave_acesso + "." + ex.Message);
            }
            finally
            {
                stbSQL = null;
        ...
        #region " Inserir XML Completo "

        public int InserirXMLCTe(Common.SerializableClasses.CTe.xmlCTe_v400_NT202402.proc CTe)
        {
            // Classes e variaveis utilizadas
            AcessoDados clsDados = new AcessoDados();
            Facilitador clsFacil = new Facilitador();
            ...
            try
            {
                ...
                strSQL = Inserir_chave_acesso_esquema_conhecimento_transporte_eletronico(CTe.CteProc.protCTe.InfProt.chCTe, "1");
                strSQL += clsInserirCTe.InserirXML_detalhe_xml_conhecimento_transporte_eletronico_autorizado(CTe);
                strSQL += clsInserirCTe.InserirXML_detalhe_xml_conhecimento_transporte_eletronico_autorizado_download(CTe);
                strSQL += clsInserirCTe.InserirXML_detalhe_xml_conhecimento_transporte_eletronico_fluxo_carga(CTe);
                strSQL += clsInserirCTe.InserirXML_detalhe_xml_conhecimento_transporte_eletronico_informacao_contribuinte(CTe);
                strSQL += clsInserirCTe.InserirXML_detalhe_xml_conhecimento_transporte_eletronico_informacao_fisco(CTe);
                strSQL += clsInserirCTe.InserirXML_detalhe_xml_conhecimento_transporte_eletronico_componente_prestacao(CTe);
                strSQL += clsInserirCTe.InserirXML_detalhe_xml_conhecimento_transporte_eletronico_carga(CTe);

                //infNF
                if (CTe.CteProc.CTe.infCte.infCTeNorm.infDoc.infNF.Count > 0)
                {
                    strSQL += clsInserirCTe.InserirXML_detalhe_xml_conhecimento_transporte_eletronico_nota_fiscal(CTe);
                    strSQL += clsInserirCTe.InserirXML_detalhe_xml_conhecimento_transporte_eletronico_unidade_carga_infNF(CTe);
                    strSQL += clsInserirCTe.InserirXML_detalhe_xml_conhecimento_transporte_eletronico_unidade_carga_lacre_infNF(CTe);
                    strSQL += clsInserirCTe.InserirXML_detalhe_xml_conhecimento_transporte_eletronico_unidade_transporte_infNF(CTe);
                    strSQL += clsInserirCTe.InserirXML_detalhe_xml_conhecimento_transporte_eletronico_unidade_transporte_lacre_infNF(CTe);
                    strSQL += clsInserirCTe.InserirXML_detalhe_xml_conhecimento_transporte_eletronico_unidade_transporte_unidade_carga_infNF(CTe);
                    strSQL += clsInserirCTe.InserirXML_detalhe_xml_conhecimento_transporte_eletronico_unidade_transporte_unidade_carga_lacre_infNF(CTe);
                }
                //infNFe
                if (CTe.CteProc.CTe.infCte.infCTeNorm.infDoc.infNFe.Count > 0)
                {
                    strSQL += clsInserirCTe.InserirXML_detalhe_xml_conhecimento_transporte_eletronico_nota_fiscal_eletronica(CTe);
                    strSQL += clsInserirCTe.InserirXML_detalhe_xml_conhecimento_transporte_eletronico_unidade_carga_infNFe(CTe);
                    strSQL += clsInserirCTe.InserirXML_detalhe_xml_conhecimento_transporte_eletronico_unidade_carga_lacre_infNFe(CTe);
                    strSQL += clsInserirCTe.InserirXML_detalhe_xml_conhecimento_transporte_eletronico_unidade_transporte_infNFe(CTe);
                    strSQL += clsInserirCTe.InserirXML_detalhe_xml_conhecimento_transporte_eletronico_unidade_transporte_lacre_infNFe(CTe);
                    strSQL += clsInserirCTe.InserirXML_detalhe_xml_conhecimento_transporte_eletronico_unidade_transporte_unidade_carga_infNFe(CTe);
                    strSQL += clsInserirCTe.InserirXML_detalhe_xml_conhecimento_transporte_eletronico_unidade_transporte_unidade_carga_lacre_infNFe(CTe);
                }
                //infOutros
                if (CTe.CteProc.CTe.infCte.infCTeNorm.infDoc.infOutros.Count > 0)
                {
                    strSQL += clsInserirCTe.InserirXML_detalhe_xml_conhecimento_transporte_eletronico_outro_documento(CTe);
                    strSQL += clsInserirCTe.InserirXML_detalhe_xml_conhecimento_transporte_eletronico_unidade_carga_infOutros(CTe);
                    strSQL += clsInserirCTe.InserirXML_detalhe_xml_conhecimento_transporte_eletronico_unidade_carga_lacre_infOutros(CTe);
                    strSQL += clsInserirCTe.InserirXML_detalhe_xml_conhecimento_transporte_eletronico_unidade_transporte_infOutros(CTe);
                    strSQL += clsInserirCTe.InserirXML_detalhe_xml_conhecimento_transporte_eletronico_unidade_transporte_lacre_infOutros(CTe);
                    strSQL += clsInserirCTe.InserirXML_detalhe_xml_conhecimento_transporte_eletronico_unidade_transporte_unidade_carga_infOutros(CTe);
                    strSQL += clsInserirCTe.InserirXML_detalhe_xml_conhecimento_transporte_eletronico_unidade_transporte_unidade_carga_lacre_infOutros(CTe);
                }

                strSQL += clsInserirCTe.InserirXML_detalhe_xml_conhecimento_transporte_eletronico_transporte_emissor_anterior(CTe);
                strSQL += clsInserirCTe.InserirXML_detalhe_xml_conhecimento_transporte_eletronico_transporte_anterior_papel(CTe);
                strSQL += clsInserirCTe.InserirXML_detalhe_xml_conhecimento_transporte_eletronico_transporte_anterior_eletronico(CTe);

                strSQL += clsInserirCTe.InserirXML_detalhe_xml_conhecimento_transporte_eletronico_veiculo(CTe);
                strSQL += clsInserirCTe.InserirXML_detalhe_xml_conhecimento_transporte_eletronico_cobranca_duplicata(CTe);
                strSQL += clsInserirCTe.InserirXML_detalhe_xml_conhecimento_transporte_eletronico_multimodal_vinculado(CTe);
                strSQL += clsInserirCTe.InserirXML_detalhe_xml_conhecimento_transporte_eletronico_complementado(CTe);

                if (CTe.CteProc.CTe.infCte.infCTeNorm.infModal.versaoModal != null)
                {
                    if (CTe.CteProc.CTe.infCte.ide.modal == "01")
                    {
                        strSQL += clsInserirCTe.InserirXML_detalhe_xml_conhecimento_transporte_eletronico_modal_rodoviario(CTe);
                    }
                    if (CTe.CteProc.CTe.infCte.ide.modal == "02")
                    {
                        strSQL += clsInserirCTe.InserirXML_detalhe_xml_conhecimento_transporte_eletronico_modal_aereo(CTe);
                        strSQL += clsInserirCTe.InserirXML_detalhe_xml_conhecimento_transporte_eletronico_modal_aereo_natureza_carga(CTe);
                        strSQL += clsInserirCTe.InserirXML_detalhe_xml_conhecimento_transporte_eletronico_modal_aereo_perigo_onu(CTe);
                    }
                    if (CTe.CteProc.CTe.infCte.ide.modal == "03")
                    {
                        strSQL += clsInserirCTe.InserirXML_detalhe_xml_conhecimento_transporte_eletronico_modal_aquaviario(CTe);
                        strSQL += clsInserirCTe.InserirXML_detalhe_xml_conhecimento_transporte_eletronico_modal_aquaviario_balsa(CTe);
                        strSQL += clsInserirCTe.InserirXML_detalhe_xml_conhecimento_transporte_eletronico_modal_aquaviario_conteiner(CTe);
                        strSQL += clsInserirCTe.InserirXML_detalhe_xml_conhecimento_transporte_eletronico_modal_aquaviario_conteiner_lacre(CTe);
                        strSQL += clsInserirCTe.InserirXML_detalhe_xml_conhecimento_transporte_eletronico_modal_aquaviario_nota_fiscal(CTe);
                        strSQL += clsInserirCTe.InserirXML_detalhe_xml_conhecimento_transporte_eletronico_modal_aquaviario_nota_fiscal_eletronica(CTe);
                    }
                    if (CTe.CteProc.CTe.infCte.ide.modal == "04")
                    {
                        strSQL += clsInserirCTe.InserirXML_detalhe_xml_conhecimento_transporte_eletronico_modal_ferroviario(CTe);
                        strSQL += clsInserirCTe.InserirXML_detalhe_xml_conhecimento_transporte_eletronico_modal_ferroviario_ferrovia(CTe);
                    }
                    if (CTe.CteProc.CTe.infCte.ide.modal == "05")
                    {
                        strSQL += clsInserirCTe.InserirXML_detalhe_xml_conhecimento_transporte_eletronico_modal_dutoviario(CTe);
                    }
                    if (CTe.CteProc.CTe.infCte.ide.modal == "06")
                    {
                        strSQL += clsInserirCTe.InserirXML_detalhe_xml_conhecimento_transporte_eletronico_modal_multimodal(CTe);
                    }
                }
        ...
        public int InserirXMLCTeOS(Common.SerializableClasses.CTe.ClsCTeOS_v4.proc CTeOS)
        {
            // Classes e variaveis utilizadas
            AcessoDados clsDados = new AcessoDados();
            Facilitador clsFacil = new Facilitador();
            string strSQL = string.Empty;
            ClsInserirCTeOS clsInserirCTeOS = new ClsInserirCTeOS();
            string strMetodo = System.Reflection.MethodBase.GetCurrentMethod().Name;
            int intRetorno = 0;
            ...
            try
            {
                ...
                strSQL = Inserir_chave_acesso_esquema_conhecimento_transporte_eletronico(CTeOS.cteOSProc.protCTe.InfProt.chCTe, "2");
                strSQL += clsInserirCTeOS.InserirXML_detalhe_xml_conhecimento_transporte_eletronico_outro_servico_autorizado(CTeOS);
                strSQL += clsInserirCTeOS.InserirXML_detalhe_xml_conhecimento_transporte_eletronico_outro_servico_autorizado_download(CTeOS);
                strSQL += clsInserirCTeOS.InserirXML_detalhe_xml_conhecimento_transporte_eletronico_outro_servico_complementado(CTeOS);
                strSQL += clsInserirCTeOS.InserirXML_detalhe_xml_conhecimento_transporte_eletronico_outro_servico_info_contrib(CTeOS);
                strSQL += clsInserirCTeOS.InserirXML_detalhe_xml_conhecimento_transporte_eletronico_outro_servico_info_fisco(CTeOS);
                strSQL += clsInserirCTeOS.InserirXML_detalhe_xml_conhecimento_transporte_eletronico_outro_servico_componente(CTeOS);
                strSQL += clsInserirCTeOS.InserirXML_detalhe_xml_conhecimento_transporte_eletronico_outro_servico_gtve(CTeOS);
                strSQL += clsInserirCTeOS.InserirXML_detalhe_xml_conhecimento_transporte_eletronico_outro_servico_componente_valor_gtve(CTeOS);
                strSQL += clsInserirCTeOS.InserirXML_detalhe_xml_conhecimento_transporte_eletronico_outro_servico_documento_referenciado(CTeOS);
                strSQL += clsInserirCTeOS.InserirXML_detalhe_xml_conhecimento_transporte_eletronico_outro_servico_duplicata(CTeOS);
                strSQL += clsInserirCTeOS.InserirXML_detalhe_xml_conhecimento_transporte_eletronico_outro_servico_percurso(CTeOS);
                strSQL += clsInserirCTeOS.InserirXML_detalhe_xml_conhecimento_transporte_eletronico_outro_servico_seguro_carga(CTeOS);
                if (CTeOS.cteOSProc.CTeOS.infCte.infCTeNorm.infModal.versaoModal != null)
                {
                    if (CTeOS.cteOSProc.CTeOS.infCte.ide.modal == "01")
                    {
                        strSQL += clsInserirCTeOS.InserirXML_detalhe_xml_conhecimento_transporte_eletronico_outro_servico_modal_rodoviario(CTeOS);
                    }
            ...
            catch (Exception ex)
            {
                ...
                clsDados.RollbackTransaction();
                throw new ArgumentException($"[{strMetodo}]: " + " - chCTe: " + CTeOS.cteOSProc.protCTe.InfProt.chCTe + "." + ex.Message);
            }
            finally
            {
                clsDados = null;
        ...
        public int InserirXMLGTVe(Common.SerializableClasses.CTe.ClsXmlGTVeNT202402.proc GTVe)
        {
            // Classes e variaveis utilizadas
            AcessoDados clsDados = new AcessoDados();
            Facilitador clsFacil = new Facilitador();
            string strSQL = string.Empty;
            ClsInserirGTVe clsInserirGTVe = new ClsInserirGTVe();
            string strMetodo = System.Reflection.MethodBase.GetCurrentMethod().Name;
            ...
            try
            {
                ...
                strSQL = Inserir_chave_acesso_esquema_conhecimento_transporte_eletronico(GTVe.GTVeProc.protCTe.InfProt.chCTe, "3");
                strSQL += clsInserirGTVe.InserirXML_detalhe_xml_guia_transporte_valor_eletronico_autorizado(GTVe);
                strSQL += clsInserirGTVe.InserirXML_detalhe_xml_guia_transporte_valor_eletronico_autorizado_download(GTVe);
                strSQL += clsInserirGTVe.InserirXML_detalhe_xml_guia_transporte_valor_eletronico_info_contribuinte(GTVe);
                strSQL += clsInserirGTVe.InserirXML_detalhe_xml_guia_transporte_valor_eletronico_info_fisco(GTVe);
                strSQL += clsInserirGTVe.InserirXML_detalhe_xml_guia_transporte_valor_eletronico_grupo_informacao_detalhada(GTVe);
                strSQL += clsInserirGTVe.InserirXML_detalhe_xml_guia_transporte_valor_eletronico_veiculo(GTVe);
                strSQL += clsInserirGTVe.InserirXML_detalhe_xml_guia_transporte_valor_eletronico_especie_transportada(GTVe);
            ...
            {
                clsDados.RollbackTransaction();
                throw new ArgumentException($"[{strMetodo}]: " + " - chCTe: " + GTVe.GTVeProc.protCTe.InfProt.chCTe + "." + ex.Message);
        ...
        public int InserirXMLCTeSimp(Common.SerializableClasses.CTe.xmlCTeSimp_v400.proc CTe)
        {
            // Classes e variaveis utilizadas
            AcessoDados clsDados = new AcessoDados();
            Facilitador clsFacil = new Facilitador();
            string strSQL = string.Empty;
            ClsInserirCTeSimp clsInserirCTeSimp = new ClsInserirCTeSimp();
            string strMetodo = System.Reflection.MethodBase.GetCurrentMethod().Name;
            ...
            try
            {
                ...
                strSQL = Inserir_chave_acesso_esquema_conhecimento_transporte_eletronico(CTe.CteSimpProc.protCTe.InfProt.chCTe, "4");
                strSQL += clsInserirCTeSimp.InserirXML_detalhe_xml_conhecimento_transporte_eletronico_simp_autorizado(CTe);
                strSQL += clsInserirCTeSimp.InserirXML_detalhe_xml_conhecimento_transporte_eletronico_simp_autorizado_download(CTe);
                strSQL += clsInserirCTeSimp.InserirXML_detalhe_xml_conhecimento_transporte_eletronico_simp_informacao_contribuinte(CTe);
                strSQL += clsInserirCTeSimp.InserirXML_detalhe_xml_conhecimento_transporte_eletronico_simp_informacao_fisco(CTe);
                strSQL += clsInserirCTeSimp.InserirXML_detalhe_xml_conhecimento_transporte_eletronico_simp_registro_passagem(CTe);
                strSQL += clsInserirCTeSimp.InserirXML_detalhe_xml_conhecimento_transporte_eletronico_simp_duplicata(CTe);
                strSQL += clsInserirCTeSimp.InserirXML_detalhe_xml_conhecimento_transporte_eletronico_simp_det_entrega(CTe);
                strSQL += clsInserirCTeSimp.InserirXML_detalhe_xml_conhecimento_transporte_eletronico_simp_det_entrega_componente(CTe);
                strSQL += clsInserirCTeSimp.InserirXML_detalhe_xml_conhecimento_transporte_eletronico_simp_det_entrega_info_doc_ant(CTe);
                strSQL += clsInserirCTeSimp.InserirXML_detalhe_xml_conhecimento_transporte_eletronico_simp_det_entrega_info_doc_ant_transp_parcial(CTe);
                strSQL += clsInserirCTeSimp.InserirXML_detalhe_xml_conhecimento_transporte_eletronico_simp_det_entrega_info_nfe(CTe);
                strSQL += clsInserirCTeSimp.InserirXML_detalhe_xml_conhecimento_transporte_eletronico_simp_det_entrega_info_nfe_unidade_carga(CTe);
                strSQL += clsInserirCTeSimp.InserirXML_detalhe_xml_conhecimento_transporte_eletronico_simp_det_entrega_info_nfe_unidade_carga_lacre(CTe);
                strSQL += clsInserirCTeSimp.InserirXML_detalhe_xml_conhecimento_transporte_eletronico_simp_det_entrega_info_nfe_unidade_transporte(CTe);
                strSQL += clsInserirCTeSimp.InserirXML_detalhe_xml_conhecimento_transporte_eletronico_simp_det_entrega_info_nfe_unidade_transporte_lacre(CTe);
                strSQL += clsInserirCTeSimp.InserirXML_detalhe_xml_conhecimento_transporte_eletronico_simp_det_entrega_info_nfe_unidade_transporte_unidade_carga(CTe);
                strSQL += clsInserirCTeSimp.InserirXML_detalhe_xml_conhecimento_transporte_eletronico_simp_det_entrega_info_nfe_unidade_transporte_unidade_carga_lacre(CTe);

                if (CTe.CteSimpProc.CTeSimp.infCte.infModal.versaoModal != null)
                {
                    if (CTe.CteSimpProc.CTeSimp.infCte.ide.modal == "01")
                    {
                        strSQL += clsInserirCTeSimp.InserirXML_detalhe_xml_conhecimento_transporte_eletronico_simp_modal_rodoviario(CTe);
                    }
                    if (CTe.CteSimpProc.CTeSimp.infCte.ide.modal == "02")
                    {
                        strSQL += clsInserirCTeSimp.InserirXML_detalhe_xml_conhecimento_transporte_eletronico_simp_modal_aereo(CTe);
                        strSQL += clsInserirCTeSimp.InserirXML_detalhe_xml_conhecimento_transporte_eletronico_simp_modal_aereo_natureza_carga(CTe);
                        strSQL += clsInserirCTeSimp.InserirXML_detalhe_xml_conhecimento_transporte_eletronico_simp_modal_aereo_perigo_onu(CTe);
                    }
                    if (CTe.CteSimpProc.CTeSimp.infCte.ide.modal == "03")
                    {
                        strSQL += clsInserirCTeSimp.InserirXML_detalhe_xml_conhecimento_transporte_eletronico_simp_modal_aquaviario(CTe);
                        strSQL += clsInserirCTeSimp.InserirXML_detalhe_xml_conhecimento_transporte_eletronico_simp_modal_aquaviario_balsa(CTe);
                        strSQL += clsInserirCTeSimp.InserirXML_detalhe_xml_conhecimento_transporte_eletronico_simp_modal_aquaviario_conteiner(CTe);
                        strSQL += clsInserirCTeSimp.InserirXML_detalhe_xml_conhecimento_transporte_eletronico_simp_modal_aquaviario_conteiner_lacre(CTe);
                        strSQL += clsInserirCTeSimp.InserirXML_detalhe_xml_conhecimento_transporte_eletronico_simp_modal_aquaviario_nota_fiscal(CTe);
                        strSQL += clsInserirCTeSimp.InserirXML_detalhe_xml_conhecimento_transporte_eletronico_simp_modal_aquaviario_nota_fiscal_eletronica(CTe);
                    }
                    if (CTe.CteSimpProc.CTeSimp.infCte.ide.modal == "04")
                    {
                        strSQL += clsInserirCTeSimp.InserirXML_detalhe_xml_conhecimento_transporte_eletronico_simp_modal_ferroviario(CTe);
                        strSQL += clsInserirCTeSimp.InserirXML_detalhe_xml_conhecimento_transporte_eletronico_simp_modal_ferroviario_ferrovia(CTe);
                    }
                    if (CTe.CteSimpProc.CTeSimp.infCte.ide.modal == "05")
                    {
                        strSQL += clsInserirCTeSimp.InserirXML_detalhe_xml_conhecimento_transporte_eletronico_simp_modal_dutoviario(CTe);
                    }
                    if (CTe.CteSimpProc.CTeSimp.infCte.ide.modal == "06")
                    {
                        strSQL += clsInserirCTeSimp.InserirXML_detalhe_xml_conhecimento_transporte_eletronico_simp_modal_multimodal(CTe);
                    }
                }
            ...
            {
                clsDados.RollbackTransaction();
                throw new ArgumentException($"[{strMetodo}]: " + " - chCTe: " + CTe.CteSimpProc.protCTe.InfProt.chCTe + "." + ex.Message);
        ...
        public int InserirXMLCTeV2(Common.SerializableClasses.CTe.ClsCTe_v2.proc CTe)
        {
            // Classes e variaveis utilizadas
            AcessoDados clsDados = new AcessoDados();
            Facilitador clsFacil = new Facilitador();
            string strSQL = string.Empty;
            ClsInserirCTeV2 clsInserirCTe = new ClsInserirCTeV2();
            string strMetodo = System.Reflection.MethodBase.GetCurrentMethod().Name;
            int intRetorno = 0;
        ...
        public int InserirXMLCTeV1(Common.SerializableClasses.CTe.ClsCTe_v1.proc CTe)
        {
            // Classes e variaveis utilizadas
            AcessoDados clsDados = new AcessoDados();
            Facilitador clsFacil = new Facilitador();
            string strSQL = string.Empty;
            ClsInserirCTeV1 clsInserirCTe = new ClsInserirCTeV1();
            string strMetodo = System.Reflection.MethodBase.GetCurrentMethod().Name;
            int intRetorno = 0;
            ...
            try
            {
                ...
                ////infNF
                if (CTe.CteProc.CTe.infCte.rem.infNF.Count > 0)
                {
                    strSQL += clsInserirCTe.InserirXML_detalhe_xml_conhecimento_transporte_eletronico_nota_fiscal(CTe);
                }
                ////infNFe
                if (CTe.CteProc.CTe.infCte.rem.infNFe.Count > 0)
                {
                    strSQL += clsInserirCTe.InserirXML_detalhe_xml_conhecimento_transporte_eletronico_nota_fiscal_eletronica(CTe);
                }
                ////infOutros
                if (CTe.CteProc.CTe.infCte.rem.infOutros.Count > 0)
                {
                    strSQL += clsInserirCTe.InserirXML_detalhe_xml_conhecimento_transporte_eletronico_outro_documento(CTe);
                }
        ...
        #region " Inserir Evento CTe "

        public int InserirXML_detalhe_xml_conhecimento_transporte_eletronico_evento(Common.SerializableClasses.CTe.xmlEventoCTe_v400.proc eventoCTe)
        {
            // Classes e variaveis utilizadas
            AcessoDados clsDados = new AcessoDados();
            Facilitador clsFacil = new Facilitador();
            ...
            try
            {
                ...
                // Montando query a ser executada
                stbSQL.Append(clsFacil.MontarQuery("INSERT INTO cte.detalhe_xml_conhecimento_transporte_eletronico_evento "));
                stbSQL.Append(clsFacil.MontarQuery("( "));
                stbSQL.Append(clsFacil.MontarQuery("  dtr_referencia, "));
                stbSQL.Append(clsFacil.MontarQuery("  cod_chave_acesso, "));
                stbSQL.Append(clsFacil.MontarQuery("  seq_evento, "));
                ...
                stbSQL.Append(clsFacil.MontarQuery("  num_cnpj_cpf_base_emissor, "));
                stbSQL.Append(clsFacil.MontarQuery("  num_cnpj_cpf_filial_emissor, "));
                stbSQL.Append(clsFacil.MontarQuery("  dig_cnpj_cpf_emissor, "));
                stbSQL.Append(clsFacil.MontarQuery("  num_orgao_recepcao_evento_informado_ambiente_nacional, "));
                ...
                stbSQL.Append(clsFacil.MontarQuery("  des_evento, "));
                stbSQL.Append(clsFacil.MontarQuery("  dtc_atualizacao, "));
                stbSQL.Append(clsFacil.MontarQuery("  num_sequencial_unico_autorizacao "));
                stbSQL.Append(clsFacil.MontarQuery(") "));
                stbSQL.Append(clsFacil.MontarQuery("VALUES "));
                ...
                // Montando parametros
                clsDados.LimparParametro();
                clsFacil.AdicionarParametro(ref strSQL, "20" + eventoCTe.procEventoCTe.eventoCTe.infEvento.chCTe.Substring(2, 4), "@dtr_referencia", SqlDbType.Int);
                clsFacil.AdicionarParametro(ref strSQL, eventoCTe.procEventoCTe.eventoCTe.infEvento.chCTe, "@cod_chave_acesso", SqlDbType.VarChar);
                clsFacil.AdicionarParametro(ref strSQL, eventoCTe.procEventoCTe.eventoCTe.infEvento.nSeqEvento, "@seq_evento", SqlDbType.SmallInt);
                clsFacil.AdicionarParametro(ref strSQL, eventoCTe.procEventoCTe.eventoCTe.infEvento.tpEvento, "@cod_tipo_evento_documento_fiscal_eletronico", SqlDbType.Int);
                clsFacil.AdicionarParametro(ref strSQL, eventoCTe.NSUSVD, "@num_sequencial_unico", SqlDbType.BigInt);
                clsFacil.AdicionarParametro(ref strSQL, eventoCTe.procEventoCTe.retEventoCTe.retInfEvento.nProt, "@num_protocolo", SqlDbType.BigInt);

                if (eventoCTe.procEventoCTe.eventoCTe.infEvento.CPF != null)
                {
                    clsFacil.AdicionarParametro(ref strSQL, eventoCTe.procEventoCTe.eventoCTe.infEvento.CPF.Substring(0, 9), "@num_cnpj_cpf_base_emissor", SqlDbType.VarChar);
                    clsFacil.AdicionarParametro(ref strSQL, "0", "@num_cnpj_cpf_filial_emissor", SqlDbType.VarChar);
                    clsFacil.AdicionarParametro(ref strSQL, eventoCTe.procEventoCTe.eventoCTe.infEvento.CPF.Substring(9, 2), "@dig_cnpj_cpf_emissor", SqlDbType.SmallInt);
                }
                if (eventoCTe.procEventoCTe.eventoCTe.infEvento.CNPJ != null)
                {
                    clsFacil.AdicionarParametro(ref strSQL, eventoCTe.procEventoCTe.eventoCTe.infEvento.CNPJ.Substring(0, 8), "@num_cnpj_cpf_base_emissor", SqlDbType.VarChar);
                    clsFacil.AdicionarParametro(ref strSQL, eventoCTe.procEventoCTe.eventoCTe.infEvento.CNPJ.Substring(8, 4), "@num_cnpj_cpf_filial_emissor", SqlDbType.VarChar);
                    clsFacil.AdicionarParametro(ref strSQL, eventoCTe.procEventoCTe.eventoCTe.infEvento.CNPJ.Substring(12, 2), "@dig_cnpj_cpf_emissor", SqlDbType.SmallInt);
                }
                if ((eventoCTe.procEventoCTe.eventoCTe.infEvento.CPF == null && eventoCTe.procEventoCTe.eventoCTe.infEvento.CNPJ == null) || (eventoCTe.procEventoCTe.eventoCTe.infEvento.CPF == null && eventoCTe.procEventoCTe.eventoCTe.infEvento.CNPJ == string.Empty) || (eventoCTe.procEventoCTe.eventoCTe.infEvento.CPF == string.Empty && eventoCTe.procEventoCTe.eventoCTe.infEvento.CNPJ == null))
                {
                    clsFacil.AdicionarParametro(ref strSQL, string.Empty, "@num_cnpj_cpf_base_emissor", SqlDbType.Int);
                    clsFacil.AdicionarParametro(ref strSQL, string.Empty, "@num_cnpj_cpf_filial_emissor", SqlDbType.SmallInt);
                    clsFacil.AdicionarParametro(ref strSQL, string.Empty, "@dig_cnpj_cpf_emissor", SqlDbType.SmallInt);
                }

                clsFacil.AdicionarParametro(ref strSQL, eventoCTe.procEventoCTe.eventoCTe.infEvento.cOrgao, "@num_orgao_recepcao_evento_informado_ambiente_nacional", SqlDbType.Int);
                clsFacil.AdicionarParametro(ref strSQL, eventoCTe.procEventoCTe.eventoCTe.infEvento.dhEvento, "@dtc_pedido_evento", SqlDbType.DateTime);
                clsFacil.AdicionarParametro(ref strSQL, eventoCTe.procEventoCTe.retEventoCTe.retInfEvento.dhRegEvento, "@dtc_registro_evento", SqlDbType.DateTime);
                clsFacil.AdicionarParametro(ref strSQL, eventoCTe.procEventoCTe.ipTransmissor, "@des_endereco_logico", SqlDbType.VarChar);
                clsFacil.AdicionarParametro(ref strSQL, eventoCTe.procEventoCTe.retEventoCTe.retInfEvento.xEvento, "@des_evento", SqlDbType.VarChar);
                clsFacil.AdicionarParametro(ref strSQL, eventoCTe.NSUAut, "@num_sequencial_unico_autorizacao", SqlDbType.SmallInt);
            ...
            catch (Exception ex)
            {
                ...
                clsDados.RollbackTransaction();
                throw new ArgumentException($"[{strMetodo}]: " + " - chCTe: " + eventoCTe.procEventoCTe.eventoCTe.infEvento.chCTe + "." + ex.Message);
            }
            finally
            {
                stbSQL = null;
