...
namespace DFe
{
    class BdCTeSintetico
    {
        ...
        public BdCTeSintetico(Facilitador clsFacilPar, string strConexao)
        {
        ...
        public int ExcluirLogs(int intTop)
        {
            // Classes e variaveis utilizadas
            AcessoDados clsDados = new AcessoDados();
            StringBuilder stbSQL = new StringBuilder();
            ...
            {
                // Montando query a ser executada
                stbSQL.Append(clsFacil.MontarQuery("DELETE TOP(" + intTop.ToString() + ") "));
                stbSQL.Append(clsFacil.MontarQuery("FROM "));
                stbSQL.Append(clsFacil.MontarQuery("  cte.log_sintetico_conhecimento_transporte_eletronico "));
                string strSQL = stbSQL.ToString();
        ...
        public DataSet ObterLogs(int intTop)
        {
            // Classes e variaveis utilizadas
            AcessoDados clsDados = new AcessoDados();
            StringBuilder stbSQL = new StringBuilder();
            ...
            try
            {
                ...
                stbSQL.Append(clsFacil.MontarQuery("  l.seq_log_sintetico_conhecimento_transporte_eletronico as seq_log, "));
                stbSQL.Append(clsFacil.MontarQuery("  l.des_log, "));
                stbSQL.Append(clsFacil.MontarQuery("  l.cod_servico_sintetico_conhecimento_transporte_eletronico as cod_servico, "));
                stbSQL.Append(clsFacil.MontarQuery("  s.des_servico, "));
                stbSQL.Append(clsFacil.MontarQuery("  l.dtc_insercao, "));
                stbSQL.Append(clsFacil.MontarQuery("  l.dtc_atualizacao "));
                stbSQL.Append(clsFacil.MontarQuery("FROM "));
                stbSQL.Append(clsFacil.MontarQuery("  cte.log_sintetico_conhecimento_transporte_eletronico l WITH (READPAST) "));
                stbSQL.Append(clsFacil.MontarQuery("  INNER JOIN cte.servico_sintetico_conhecimento_transporte_eletronico s WITH (READPAST) "));
                stbSQL.Append(clsFacil.MontarQuery("  ON (l.cod_servico_sintetico_conhecimento_transporte_eletronico = s.cod_servico_sintetico_conhecimento_transporte_eletronico) "));
                string strSQL = stbSQL.ToString();
        ...
        public int InserirAutorizacao(string strDataReferencia, string strChaveAcesso, string strProtocolo, string strNSU, string strXML, string strData)
        {
            // Classes e variaveis utilizadas
            AcessoDados clsDados = new AcessoDados();
            StringBuilder stbSQL = new StringBuilder();
            ...
            {
                // Montando query a ser executada
                stbSQL.Append(clsFacil.MontarQuery("INSERT INTO cte.documento_conhecimento_transporte_eletronico_autorizacao "));
                stbSQL.Append(clsFacil.MontarQuery("( "));
                ...
                stbSQL.Append(clsFacil.MontarQuery("  xml_documento, "));
                ...
                stbSQL.Append(clsFacil.MontarQuery("  @num_protocolo, "));
                stbSQL.Append(clsFacil.MontarQuery("  @num_sequencial_unico, "));
                stbSQL.Append(clsFacil.MontarQuery("  convert(varbinary(max),@xml_documento), "));
                stbSQL.Append(clsFacil.MontarQuery("  @dtc_documento, "));
                stbSQL.Append(clsFacil.MontarQuery("  getdate(), "));
                stbSQL.Append(clsFacil.MontarQuery("  getdate() "));
                stbSQL.Append(clsFacil.MontarQuery(") "));
                ...
                clsFacil.AdicionarParametro(ref strSQL, strProtocolo, "@num_protocolo", SqlDbType.BigInt);
                clsFacil.AdicionarParametro(ref strSQL, strNSU, "@num_sequencial_unico", SqlDbType.BigInt);
                clsFacil.AdicionarParametro(ref strSQL, strXML, "@xml_documento", SqlDbType.VarChar);
                clsFacil.AdicionarParametro(ref strSQL, strData, "@dtc_documento", SqlDbType.DateTime);
        ...
        public int InserirEvento(string strDataReferencia, string strChaveAcesso, string strTipoEvento, string strSeqEvento, string strProtocolo, string strNSU, string strXML, string strData)
        {
            // Classes e variaveis utilizadas
            AcessoDados clsDados = new AcessoDados();
            StringBuilder stbSQL = new StringBuilder();
            ...
            {
                // Montando query a ser executada
                stbSQL.Append(clsFacil.MontarQuery("INSERT INTO cte.documento_conhecimento_transporte_eletronico_evento "));
                stbSQL.Append(clsFacil.MontarQuery("( "));
                stbSQL.Append(clsFacil.MontarQuery("  dtr_referencia, "));
                stbSQL.Append(clsFacil.MontarQuery("  cod_chave_acesso, "));
                ...
                stbSQL.Append(clsFacil.MontarQuery("  @dtr_referencia, "));
                stbSQL.Append(clsFacil.MontarQuery("  @cod_chave_acesso, "));
                stbSQL.Append(clsFacil.MontarQuery("  @cod_tipo_evento, "));
                ...
                clsFacil.AdicionarParametro(ref strSQL, strDataReferencia, "@dtr_referencia", SqlDbType.Int);
                clsFacil.AdicionarParametro(ref strSQL, strChaveAcesso, "@cod_chave_acesso", SqlDbType.Char);
                clsFacil.AdicionarParametro(ref strSQL, strTipoEvento, "@cod_tipo_evento", SqlDbType.Int);
                clsFacil.AdicionarParametro(ref strSQL, strSeqEvento, "@seq_evento", SqlDbType.TinyInt);
                clsFacil.AdicionarParametro(ref strSQL, strProtocolo, "@num_protocolo", SqlDbType.BigInt);
                clsFacil.AdicionarParametro(ref strSQL, strNSU, "@num_sequencial_unico", SqlDbType.BigInt);
                clsFacil.AdicionarParametro(ref strSQL, strXML, "@xml_documento", SqlDbType.VarChar);
                clsFacil.AdicionarParametro(ref strSQL, strData, "@dtc_documento", SqlDbType.DateTime);
        ...
        #region " InserirEventoRef "

        public int InserirEventoRef(string strDataReferencia, string strChaveAcesso, string strChaveAcessoRef, string strTipoEvento, string strSeqEvento, string strProtocolo, string strNSU, string strXML, string strData)
        {
            // Classes e variaveis utilizadas
            AcessoDados clsDados = new AcessoDados();
            StringBuilder stbSQL = new StringBuilder();
            ...
            {
                // Montando query a ser executada
                stbSQL.Append(clsFacil.MontarQuery("INSERT INTO cte.documento_conhecimento_transporte_eletronico_evento_referenciada "));
                stbSQL.Append(clsFacil.MontarQuery("( "));
                stbSQL.Append(clsFacil.MontarQuery("  dtr_referencia, "));
                stbSQL.Append(clsFacil.MontarQuery("  cod_chave_acesso, "));
                stbSQL.Append(clsFacil.MontarQuery("  cod_chave_acesso_referenciada, "));
                stbSQL.Append(clsFacil.MontarQuery("  cod_tipo_evento_documento_fiscal_eletronico, "));
                stbSQL.Append(clsFacil.MontarQuery("  seq_evento_documento_fiscal_eletronico, "));
                stbSQL.Append(clsFacil.MontarQuery("  num_protocolo, "));
                stbSQL.Append(clsFacil.MontarQuery("  num_sequencial_unico, "));
                ...
                clsFacil.AdicionarParametro(ref strSQL, strDataReferencia, "@dtr_referencia", SqlDbType.Int);
                clsFacil.AdicionarParametro(ref strSQL, strChaveAcesso, "@cod_chave_acesso", SqlDbType.Char);
                clsFacil.AdicionarParametro(ref strSQL, strChaveAcessoRef, "@cod_chave_acesso_referenciada", SqlDbType.Char);
                clsFacil.AdicionarParametro(ref strSQL, strTipoEvento, "@cod_tipo_evento", SqlDbType.Int);
                clsFacil.AdicionarParametro(ref strSQL, strSeqEvento, "@seq_evento", SqlDbType.TinyInt);
                clsFacil.AdicionarParametro(ref strSQL, strProtocolo, "@num_protocolo", SqlDbType.BigInt);
                clsFacil.AdicionarParametro(ref strSQL, strNSU, "@num_sequencial_unico", SqlDbType.BigInt);
        ...
        #region " ObterEventoRef "

        public DataSet ObterEventoRef(string strDataReferencia, string strChaveAcesso, string strChaveAcessoRef, string strTipoEvento, string strSeqEvento)
        {
            // Classes e variaveis utilizadas
            AcessoDados clsDados = new AcessoDados();
            StringBuilder stbSQL = new StringBuilder();
            ...
            try
            {
                ...
                stbSQL.Append(clsFacil.MontarQuery("  dtr_referencia = @dtr_referencia "));
                stbSQL.Append(clsFacil.MontarQuery("  AND cod_chave_acesso = @cod_chave_acesso "));
                if (strChaveAcessoRef != string.Empty)
                {
                    stbSQL.Append(clsFacil.MontarQuery("  AND cod_chave_acesso_referenciada = @cod_chave_acesso_referenciada "));
                }
                if (strTipoEvento != string.Empty)
                {
                    stbSQL.Append(clsFacil.MontarQuery("  AND cod_tipo_evento_documento_fiscal_eletronico = @cod_tipo_evento_documento_fiscal_eletronico "));
        ...
        #region " InserirInutilizacao "

        public int InserirInutilizacao(string strAno, string strSerie, string strFaixaInicial, string strFaixaFinal, string strCNPJCPFBase, string strCNPJCPFFilial, string strCNPJCPFDigito, string strProtocolo, string strNSU, string strXML, string strData)
        {
            // Classes e variaveis utilizadas
            AcessoDados clsDados = new AcessoDados();
            StringBuilder stbSQL = new StringBuilder();
            ...
            {
                // Montando query a ser executada
                stbSQL.Append(clsFacil.MontarQuery("INSERT INTO cte.documento_conhecimento_transporte_eletronico_inutilizacao "));
                stbSQL.Append(clsFacil.MontarQuery("( "));
                ...
                clsFacil.AdicionarParametro(ref strSQL, strCNPJCPFBase, "@num_cnpj_base_emitente", SqlDbType.VarChar);
                clsFacil.AdicionarParametro(ref strSQL, strCNPJCPFFilial, "@num_cnpj_filial_emitente", SqlDbType.VarChar);
                clsFacil.AdicionarParametro(ref strSQL, strCNPJCPFDigito, "@dig_cnpj_emi", SqlDbType.TinyInt);
                clsFacil.AdicionarParametro(ref strSQL, strProtocolo, "@num_protocolo", SqlDbType.BigInt);
                clsFacil.AdicionarParametro(ref strSQL, strNSU, "@num_sequencial_unico", SqlDbType.TinyInt);
                clsFacil.AdicionarParametro(ref strSQL, strXML, "@xml_documento", SqlDbType.VarChar);
                clsFacil.AdicionarParametro(ref strSQL, strData, "@dtc_documento", SqlDbType.DateTime);
        ...
        public DataSet ObterInutilizacao(string strAno, string strSerie, string strFaixaInicial, string strFaixaFinal, string strCNPJCPFBase, string strCNPJCPFFilial, string strCNPJCPFDigito)
        {
            ...
            try
            {
                ...
                {
                    stbSQL.Append(clsFacil.MontarQuery("  AND num_cnpj_base_emitente = @num_cnpj_base_emitente "));
                }
                if (strCNPJCPFFilial != string.Empty)
                {
                    stbSQL.Append(clsFacil.MontarQuery("  AND num_cnpj_filial_emitente = @num_cnpj_filial_emitente "));
                }
        ...
        public int InserirNSUFaltante(string strNSU)
        {
            // Classes e variaveis utilizadas
            AcessoDados clsDados = new AcessoDados();
            StringBuilder stbSQL = new StringBuilder();
            ...
            {
                // Montando query a ser executada
                stbSQL.Append(clsFacil.MontarQuery("INSERT INTO cte.documento_conhecimento_transporte_eletronico_nsu_faltante "));
                stbSQL.Append(clsFacil.MontarQuery("( "));
                stbSQL.Append(clsFacil.MontarQuery("  num_sequencial_unico, "));
                stbSQL.Append(clsFacil.MontarQuery("  qtd_tentativa_download, "));
                stbSQL.Append(clsFacil.MontarQuery("  des_mensagem_retorno, "));
                stbSQL.Append(clsFacil.MontarQuery("  dtc_atualizacao "));
                stbSQL.Append(clsFacil.MontarQuery(") "));
                stbSQL.Append(clsFacil.MontarQuery("VALUES "));
                stbSQL.Append(clsFacil.MontarQuery("( "));
                ...
                clsDados.LimparParametro();
                clsFacil.AdicionarParametro(ref strSQL, strNSU, "@num_sequencial_unico", SqlDbType.BigInt);
                clsFacil.AdicionarParametro(ref strSQL, "0", "@qtd_tentativa_download", SqlDbType.SmallInt);
                clsFacil.AdicionarParametro(ref strSQL, string.Empty, "@des_mensagem_retorno", SqlDbType.VarChar);
        ...
        #region " InserirTempFilaSintetizador "

        public int InserirTempFilaSintetizador(string strNSU, string strNSUFinal, string strProtocolo, string strQtde, string strXML, string strEsquema, string strData)
        {
            // Classes e variaveis utilizadas
            AcessoDados clsDados = new AcessoDados();
            StringBuilder stbSQL = new StringBuilder();
            ...
            {
                // Montando query a ser executada
                stbSQL.Append(clsFacil.MontarQuery("INSERT INTO cte.tmp_sintetizador_conhecimento_transporte_eletronico "));
                stbSQL.Append(clsFacil.MontarQuery("( "));
                stbSQL.Append(clsFacil.MontarQuery("  num_sequencial_unico, "));
                stbSQL.Append(clsFacil.MontarQuery("  num_sequencial_unico_final, "));
                stbSQL.Append(clsFacil.MontarQuery("  num_protocolo, "));
                stbSQL.Append(clsFacil.MontarQuery("  qtd_documento, "));
                stbSQL.Append(clsFacil.MontarQuery("  xml_documento, "));
                stbSQL.Append(clsFacil.MontarQuery("  des_esquema, "));
                stbSQL.Append(clsFacil.MontarQuery("  des_mensagem_erro, "));
                stbSQL.Append(clsFacil.MontarQuery("  dtc_autorizacao, "));
                stbSQL.Append(clsFacil.MontarQuery("  dtc_atualizacao "));
                stbSQL.Append(clsFacil.MontarQuery(") "));
                stbSQL.Append(clsFacil.MontarQuery("VALUES "));
                stbSQL.Append(clsFacil.MontarQuery("( "));
                ...
                clsDados.LimparParametro();
                clsFacil.AdicionarParametro(ref strSQL, strNSU, "@num_sequencial_unico", SqlDbType.BigInt);
                clsFacil.AdicionarParametro(ref strSQL, strNSUFinal, "@num_sequencial_unico_final", SqlDbType.BigInt);
                clsFacil.AdicionarParametro(ref strSQL, strProtocolo, "@num_protocolo", SqlDbType.BigInt);
                clsFacil.AdicionarParametro(ref strSQL, strQtde, "@qtd_documento", SqlDbType.SmallInt);
                clsFacil.AdicionarParametro(ref strSQL, strXML, "@xml_documento", SqlDbType.VarChar);
                clsFacil.AdicionarParametro(ref strSQL, strEsquema, "@des_esquema", SqlDbType.VarChar);
                clsFacil.AdicionarParametro(ref strSQL, string.Empty, "@des_mensagem_erro", SqlDbType.VarChar);
                clsFacil.AdicionarParametro(ref strSQL, strData, "@dtc_autorizacao", SqlDbType.DateTime);
        ...
        #region " AtualizarTempFilaSintetizadorErro "

        public int AtualizarTempFilaSintetizadorErro(string strNSU, string strMsgErro)
        {
            // Classes e variaveis utilizadas
            AcessoDados clsDados = new AcessoDados();
            StringBuilder stbSQL = new StringBuilder();
            ...
            try
            {
                // Montando query a ser executada
                stbSQL.Append(clsFacil.MontarQuery("UPDATE "));
                stbSQL.Append(clsFacil.MontarQuery("  cte.tmp_sintetizador_conhecimento_transporte_eletronico "));
                stbSQL.Append(clsFacil.MontarQuery("SET "));
        ...
        #region " ExcluirTempFilaSintetizador "

        public int ExcluirTempFilaSintetizador(string strNSU)
        {
            // Classes e variaveis utilizadas
            AcessoDados clsDados = new AcessoDados();
            StringBuilder stbSQL = new StringBuilder();
        ...
        #region " ObterTempFilaSintetizador "

        public DataSet ObterTempFilaSintetizador(string strNSU)
        {
            // Classes e variaveis utilizadas
            AcessoDados clsDados = new AcessoDados();
            StringBuilder stbSQL = new StringBuilder();
            ...
            try
            {
                ...
                stbSQL.Append(clsFacil.MontarQuery("  dtc_atualizacao "));
                stbSQL.Append(clsFacil.MontarQuery("FROM "));
                stbSQL.Append(clsFacil.MontarQuery("  cte.tmp_sintetizador_conhecimento_transporte_eletronico WITH (READPAST) "));
                stbSQL.Append(clsFacil.MontarQuery("WHERE "));
                stbSQL.Append(clsFacil.MontarQuery("  num_sequencial_unico = @num_sequencial_unico "));
                string strSQL = stbSQL.ToString();
        ...
        #region " ObterTempFilaSintetizadorTop "

        public DataSet ObterTempFilaSintetizadorTop(int intTop)
        {
            // Classes e variaveis utilizadas
            AcessoDados clsDados = new AcessoDados();
            StringBuilder stbSQL = new StringBuilder();
        ...
        public int EnviarFilaSintetizador(string strChave)
        {
            // Classes e variaveis utilizadas
            AcessoDados clsDados = new AcessoDados();
            StringBuilder stbSQL = new StringBuilder();
            ...
            try
            {
                ...
                stbSQL.Append(clsFacil.MontarQuery("FROM SERVICE servico_iniciador_cte_sintetizador "));
                stbSQL.Append(clsFacil.MontarQuery("TO SERVICE N'servico_alvo_cte_sintetizador' "));
                stbSQL.Append(clsFacil.MontarQuery("ON CONTRACT  contrato_cte_sintetizador "));
                stbSQL.Append(clsFacil.MontarQuery("WITH ENCRYPTION = OFF; "));
                stbSQL.Append(clsFacil.MontarQuery("SEND ON CONVERSATION @IdDialogo "));
                stbSQL.Append(clsFacil.MontarQuery("MESSAGE TYPE tipo_mensagem_cte_sintetizador (@chave); "));
                string strSQL = stbSQL.ToString();
        ...
        #region " RetirarFilaSintetizador "

        public string RetirarFilaSintetizador()
        {
            // Classes e variaveis utilizadas
            AcessoDados clsDados = new AcessoDados();
            StringBuilder stbSQL = new StringBuilder();
            ...
            try
            {
                ...
                stbSQL.Append(clsFacil.MontarQuery("FROM "));
                stbSQL.Append(clsFacil.MontarQuery("  fila_alvo_cte_sintetizador; "));
        ...
        #region " ObterQtdeFilaSintetizador "

        public long ObterQtdeFilaSintetizador()
        {
            // Classes e variaveis utilizadas
            AcessoDados clsDados = new AcessoDados();
            StringBuilder stbSQL = new StringBuilder();
            ...
            try
            {
                ...
                stbSQL.Append(clsFacil.MontarQuery("FROM "));
                stbSQL.Append(clsFacil.MontarQuery("  fila_alvo_cte_sintetizador WITH (READPAST) "));
                string strSQL = stbSQL.ToString();
        ...
        #region " InserirTempFilaAnalisador "

        public int InserirTempFilaAnalisador(string strNSU, string strProtocolo, string strXML, string strEsquema, string strData)
        {
            // Classes e variaveis utilizadas
            AcessoDados clsDados = new AcessoDados();
            StringBuilder stbSQL = new StringBuilder();
            ...
            {
                // Montando query a ser executada
                stbSQL.Append(clsFacil.MontarQuery("INSERT INTO cte.tmp_analise_conhecimento_transporte_eletronico "));
                stbSQL.Append(clsFacil.MontarQuery("( "));
                stbSQL.Append(clsFacil.MontarQuery("  num_sequencial_unico, "));
                stbSQL.Append(clsFacil.MontarQuery("  num_protocolo, "));
                stbSQL.Append(clsFacil.MontarQuery("  xml_documento, "));
        ...
        #region " AtualizarTempFilaAnalisadorErro "

        public int AtualizarTempFilaAnalisadorErro(string strNSU, string strMsgErro)
        {
            // Classes e variaveis utilizadas
            AcessoDados clsDados = new AcessoDados();
            StringBuilder stbSQL = new StringBuilder();
        ...
        #region " ExcluirTempFilaAnalisador "

        public int ExcluirTempFilaAnalisador(string strNSU)
        {
            // Classes e variaveis utilizadas
            AcessoDados clsDados = new AcessoDados();
            StringBuilder stbSQL = new StringBuilder();
        ...
        #region " ObterTempFilaAnalisador "

        public DataSet ObterTempFilaAnalisador(string strNSU)
        {
            // Classes e variaveis utilizadas
            AcessoDados clsDados = new AcessoDados();
            StringBuilder stbSQL = new StringBuilder();
        ...
        #region " ObterTempFilaAnalisadorTop "

        public DataSet ObterTempFilaAnalisadorTop(int intTop)
        {
            // Classes e variaveis utilizadas
            AcessoDados clsDados = new AcessoDados();
            StringBuilder stbSQL = new StringBuilder();
        ...
        #region " InserirTempFilaIntegrador "

        public int InserirTempFilaIntegrador(string strNSU, string strNSUFinal, string strQtde, string strXML, string strEsquema, string strData)
        {
            // Classes e variaveis utilizadas
            AcessoDados clsDados = new AcessoDados();
            StringBuilder stbSQL = new StringBuilder();
            ...
            {
                // Montando query a ser executada
                stbSQL.Append(clsFacil.MontarQuery("INSERT INTO cte.tmp_integracao_conhecimento_transporte_eletronico "));
                stbSQL.Append(clsFacil.MontarQuery("( "));
                stbSQL.Append(clsFacil.MontarQuery("  num_sequencial_unico, "));
                stbSQL.Append(clsFacil.MontarQuery("  num_sequencial_unico_final, "));
                stbSQL.Append(clsFacil.MontarQuery("  qtd_documento, "));
        ...
        #region " AtualizarTempFilaIntegradorErro "

        public int AtualizarTempFilaIntegradorErro(string strNSU, string strMsgErro)
        {
            // Classes e variaveis utilizadas
            AcessoDados clsDados = new AcessoDados();
            StringBuilder stbSQL = new StringBuilder();
            ...
            try
            {
                // Montando query a ser executada
                stbSQL.Append(clsFacil.MontarQuery("UPDATE "));
                stbSQL.Append(clsFacil.MontarQuery("  cte.tmp_integracao_conhecimento_transporte_eletronico "));
                stbSQL.Append(clsFacil.MontarQuery("SET "));
                stbSQL.Append(clsFacil.MontarQuery("  des_mensagem_erro = @des_mensagem_erro, "));
                stbSQL.Append(clsFacil.MontarQuery("  dtc_atualizacao = getdate() "));
                stbSQL.Append(clsFacil.MontarQuery("WHERE "));
        ...
        #region " ExcluirTempFilaIntegrador "

        public int ExcluirTempFilaIntegrador(string strNSU)
        {
            // Classes e variaveis utilizadas
            AcessoDados clsDados = new AcessoDados();
            StringBuilder stbSQL = new StringBuilder();
        ...
        #region " ObterTempFilaIntegrador "

        public DataSet ObterTempFilaIntegrador(string strNSU)
        {
            // Classes e variaveis utilizadas
            AcessoDados clsDados = new AcessoDados();
            StringBuilder stbSQL = new StringBuilder();
            ...
            try
            {
                ...
                stbSQL.Append(clsFacil.MontarQuery("  dtc_atualizacao "));
                stbSQL.Append(clsFacil.MontarQuery("FROM "));
                stbSQL.Append(clsFacil.MontarQuery("  cte.tmp_integracao_conhecimento_transporte_eletronico WITH (READPAST) "));
                stbSQL.Append(clsFacil.MontarQuery("WHERE "));
                stbSQL.Append(clsFacil.MontarQuery("  num_sequencial_unico = @num_sequencial_unico "));
                string strSQL = stbSQL.ToString();
        ...
        #region " ObterTempFilaIntegradorTop "

        public DataSet ObterTempFilaIntegradorTop(int intTop)
        {
            // Classes e variaveis utilizadas
            AcessoDados clsDados = new AcessoDados();
            StringBuilder stbSQL = new StringBuilder();
        ...
        public int EnviarFilaIntegrador(string strChave)
        {
            // Classes e variaveis utilizadas
            AcessoDados clsDados = new AcessoDados();
            StringBuilder stbSQL = new StringBuilder();
            ...
            try
            {
                ...
                stbSQL.Append(clsFacil.MontarQuery("DECLARE @IdDialogo UNIQUEIDENTIFIER; "));
                stbSQL.Append(clsFacil.MontarQuery("BEGIN DIALOG @IdDialogo "));
                stbSQL.Append(clsFacil.MontarQuery("FROM SERVICE servico_iniciador_cte_integrador "));
                stbSQL.Append(clsFacil.MontarQuery("TO SERVICE N'servico_alvo_cte_integrador' "));
                stbSQL.Append(clsFacil.MontarQuery("ON CONTRACT  contrato_cte_integrador "));
                stbSQL.Append(clsFacil.MontarQuery("WITH ENCRYPTION = OFF; "));
                stbSQL.Append(clsFacil.MontarQuery("SEND ON CONVERSATION @IdDialogo "));
                stbSQL.Append(clsFacil.MontarQuery("MESSAGE TYPE tipo_mensagem_cte_integrador (@chave); "));
                string strSQL = stbSQL.ToString();
        ...
        #region " RetirarFilaIntegrador "

        public string RetirarFilaIntegrador()
        {
            // Classes e variaveis utilizadas
            AcessoDados clsDados = new AcessoDados();
            StringBuilder stbSQL = new StringBuilder();
            ...
            try
            {
                ...
                stbSQL.Append(clsFacil.MontarQuery("  @data = getdate() "));
                stbSQL.Append(clsFacil.MontarQuery("FROM "));
                stbSQL.Append(clsFacil.MontarQuery("  fila_alvo_cte_integrador; "));
                stbSQL.Append(clsFacil.MontarQuery("IF @IdDialogo IS NOT NULL "));
                stbSQL.Append(clsFacil.MontarQuery("BEGIN "));
                stbSQL.Append(clsFacil.MontarQuery("  END CONVERSATION @IdDialogo; "));
                stbSQL.Append(clsFacil.MontarQuery("END "));
        ...
        #region " ObterQtdeFilaIntegrador "

        public long ObterQtdeFilaIntegrador()
        {
            // Classes e variaveis utilizadas
            AcessoDados clsDados = new AcessoDados();
            StringBuilder stbSQL = new StringBuilder();
            ...
            try
            {
                ...
                stbSQL.Append(clsFacil.MontarQuery("  COUNT(1) as total "));
                stbSQL.Append(clsFacil.MontarQuery("FROM "));
                stbSQL.Append(clsFacil.MontarQuery("  fila_alvo_cte_integrador WITH (READPAST) "));
                string strSQL = stbSQL.ToString();
