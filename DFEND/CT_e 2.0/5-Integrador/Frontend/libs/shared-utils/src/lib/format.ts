...
/** Conexão SignalR do monitor (não confundir com Integrador ligado). */
...
export function integradorStatusLabel(scmStatus?: string | null, executar?: number | null): string {
