...
No dashboard (`:4220`), **clicar em um estágio** abre a `FrontendUrl` em nova aba (só navegação — não sobe API/front).

| Sistema | API | Frontend |
|---------|-----|----------|
| Receptor | `:5010` | `:4200` |
| Arquivador | `:5020` | `:4210` |

No Ligar (DEV): paths do registry sobem API/Angular em silêncio. Em Docker/Homolog/Prod: serviços já online via container/deploy.
