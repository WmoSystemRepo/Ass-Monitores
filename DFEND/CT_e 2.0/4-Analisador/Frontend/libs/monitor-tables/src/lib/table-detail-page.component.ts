...
import { MonitorApiService, AnalisadorMonitorStore } from '@analisador/monitor-core';
import { TableDetailDto } from '@analisador/shared-data';
import {
...
export class TablesHubPageComponent {
  private readonly store = inject(AnalisadorMonitorStore);
        ...
        @if (detail()?.fila; as fila) {
          ...
          <div class="rounded border border-zinc-700 bg-zinc-900/40 p-4">
            ...
            <p class="mt-3 text-xs text-zinc-500">
              A fila não lista mensagens individuais — só a quantidade aguardando o Analisador.
            </p>
          </div>
        }
      }
