...
namespace DFe
{
    class BdCTeRecepcao
    {
        ...
        public BdCTeRecepcao(Facilitador clsFacilPar, string strConexao)
        {
        ...
        public int InserirLog(string strDescLog, string strCodServico)
        {
            ...
            try
            {
                ...
                stbSQL.Append(clsFacil.MontarQuery("INSERT INTO cte.log_recepcao_conhecimento_transporte_eletronico "));
                stbSQL.Append(clsFacil.MontarQuery("( "));
                stbSQL.Append(clsFacil.MontarQuery("  des_log, "));
                stbSQL.Append(clsFacil.MontarQuery("  cod_servico_recepcao_conhecimento_transporte_eletronico, "));
        ...
        public int ExcluirLogs(int intTop)
        {
            ...
            try
            {
                ...
                stbSQL.Append(clsFacil.MontarQuery("  cte.log_recepcao_conhecimento_transporte_eletronico "));
                string strSQL = stbSQL.ToString();
        ...
        public DataSet ObterLogs(int intTop)
        {
            ...
            try
            {
                ...
                stbSQL.Append(clsFacil.MontarQuery("  l.seq_log_recepcao_conhecimento_transporte_eletronico as seq_log, "));
                stbSQL.Append(clsFacil.MontarQuery("  l.des_log, "));
                stbSQL.Append(clsFacil.MontarQuery("  l.cod_servico_recepcao_conhecimento_transporte_eletronico as cod_servico, "));
                ...
                stbSQL.Append(clsFacil.MontarQuery("FROM "));
                stbSQL.Append(clsFacil.MontarQuery("  cte.log_recepcao_conhecimento_transporte_eletronico l WITH (READPAST) "));
                stbSQL.Append(clsFacil.MontarQuery("  INNER JOIN cte.servico_recepcao_conhecimento_transporte_eletronico s WITH (READPAST) "));
                stbSQL.Append(clsFacil.MontarQuery("  ON (l.cod_servico_recepcao_conhecimento_transporte_eletronico = s.cod_servico_recepcao_conhecimento_transporte_eletronico) "));
                string strSQL = stbSQL.ToString();
        ...
        public DataSet ObterServicos()
        {
            ...
            try
            {
                ...
                stbSQL.Append(clsFacil.MontarQuery("  c.seq_configuracao_recepcao_conhecimento_transporte_eletronico as seq_configuracao, "));
                stbSQL.Append(clsFacil.MontarQuery("  c.cod_servico_recepcao_conhecimento_transporte_eletronico as cod_servico, "));
                stbSQL.Append(clsFacil.MontarQuery("  s.des_servico, "));
                ...
                stbSQL.Append(clsFacil.MontarQuery("FROM "));
                stbSQL.Append(clsFacil.MontarQuery("  cte.configuracao_recepcao_conhecimento_transporte_eletronico c WITH (READPAST) "));
                stbSQL.Append(clsFacil.MontarQuery("  INNER JOIN cte.servico_recepcao_conhecimento_transporte_eletronico s WITH (READPAST) "));
                stbSQL.Append(clsFacil.MontarQuery("  ON (c.cod_servico_recepcao_conhecimento_transporte_eletronico = s.cod_servico_recepcao_conhecimento_transporte_eletronico) "));
                string strSQL = stbSQL.ToString();
        ...
        public string ObterServico(string strCodServico)
        {
            ...
            try
            {
                ...
                stbSQL.Append(clsFacil.MontarQuery("  dtc_atualizacao "));
                stbSQL.Append(clsFacil.MontarQuery("FROM "));
                stbSQL.Append(clsFacil.MontarQuery("  cte.servico_recepcao_conhecimento_transporte_eletronico WITH (READPAST) "));
                stbSQL.Append(clsFacil.MontarQuery("WHERE "));
                stbSQL.Append(clsFacil.MontarQuery("  cod_servico_recepcao_conhecimento_transporte_eletronico = @cod_servico "));
                string strSQL = stbSQL.ToString();
        ...
        public int AtualizarServico(string strCodServico, string strServidor)
        {
            ...
            try
            {
                ...
                stbSQL.Append(clsFacil.MontarQuery("  cte.servico_recepcao_conhecimento_transporte_eletronico "));
        ...
        public DataSet ObterConfiguracoes(string strCodServico, string strDescConfig, string strValorConfig, string strServidor)
        {
            ...
            try
            {
                ...
                {
                    stbSQL.Append(clsFacil.MontarQuery("  AND c.cod_servico_recepcao_conhecimento_transporte_eletronico = @cod_servico "));
                }
        ...
        public string ObterConfiguracao(string strCodServico, string strDescConfig)
        {
            ...
            try
            {
                ...
                stbSQL.Append(clsFacil.MontarQuery("  dtc_atualizacao "));
                stbSQL.Append(clsFacil.MontarQuery("FROM "));
                stbSQL.Append(clsFacil.MontarQuery("  cte.configuracao_recepcao_conhecimento_transporte_eletronico WITH (READPAST) "));
                stbSQL.Append(clsFacil.MontarQuery("WHERE "));
                stbSQL.Append(clsFacil.MontarQuery("  sts_ativo = 1 "));
                stbSQL.Append(clsFacil.MontarQuery("  AND cod_servico_recepcao_conhecimento_transporte_eletronico = @cod_servico "));
        ...
        public int AtualizarConfiguracao(string strCodServico, string strDescConfig, string strValorConfig, string strAtivo)
        {
            ...
            try
            {
                // Montando query a ser executada
                stbSQL.Append(clsFacil.MontarQuery("UPDATE "));
                stbSQL.Append(clsFacil.MontarQuery("  cte.configuracao_recepcao_conhecimento_transporte_eletronico "));
                stbSQL.Append(clsFacil.MontarQuery("SET "));
        ...
        public string ObterNSU(string strCodServico)
        {
            // Classes e variaveis utilizadas
            AcessoDados clsDados = new AcessoDados();
            StringBuilder stbSQL = new StringBuilder();
            ...
            try
            {
                ...
                stbSQL.Append(clsFacil.MontarQuery("  dtc_atualizacao "));
                stbSQL.Append(clsFacil.MontarQuery("FROM "));
                stbSQL.Append(clsFacil.MontarQuery("  cte.servico_recepcao_conhecimento_transporte_eletronico WITH (NOLOCK) "));
                stbSQL.Append(clsFacil.MontarQuery("WHERE "));
                stbSQL.Append(clsFacil.MontarQuery("  cod_servico_recepcao_conhecimento_transporte_eletronico = @cod_servico "));
                string strSQL = stbSQL.ToString();
                ...
                if ((dstRetorno != null) && (dstRetorno.Tables.Count > 0) && (dstRetorno.Tables[0].Rows.Count > 0))
                {
                    strRetorno = dstRetorno.Tables[0].Rows[0]["num_sequencial_unico"].ToString();
                }
            }
            catch
            {
        ...
        public int AtualizarNSU(string strCodServico, string strNSU)
        {
            // Classes e variaveis utilizadas
            AcessoDados clsDados = new AcessoDados();
            StringBuilder stbSQL = new StringBuilder();
        ...
        #region " InserirTempArquivador "

        public int InserirTempArquivador(string strNSU, string strNSUFinal, string strProtocolo, string strQtdeDocumentos, string strXML, string strEsquema, string strData)
        {
            // Classes e variaveis utilizadas
            AcessoDados clsDados = new AcessoDados();
            StringBuilder stbSQL = new StringBuilder();
            ...
            {
                // Montando query a ser executada
                stbSQL.Append(clsFacil.MontarQuery("INSERT INTO cte.tmp_documento_conhecimento_transporte_eletronico "));
                stbSQL.Append(clsFacil.MontarQuery("( "));
                stbSQL.Append(clsFacil.MontarQuery("  num_sequencial_unico, "));
                ...
                clsFacil.AdicionarParametro(ref strSQL, strQtdeDocumentos, "@qtd_documento", SqlDbType.SmallInt);
        ...
        #region " AtualizarTempArquivadorErro "

        public int AtualizarTempArquivadorErro(string strNSU, string strMsgErro)
        {
            // Classes e variaveis utilizadas
            AcessoDados clsDados = new AcessoDados();
            StringBuilder stbSQL = new StringBuilder();
            ...
            try
            {
                // Montando query a ser executada
                stbSQL.Append(clsFacil.MontarQuery("UPDATE "));
                stbSQL.Append(clsFacil.MontarQuery("  cte.tmp_documento_conhecimento_transporte_eletronico "));
                stbSQL.Append(clsFacil.MontarQuery("SET "));
        ...
        #region " ExcluirTempArquivador "

        public int ExcluirTempArquivador(string strNSU)
        {
            // Classes e variaveis utilizadas
            AcessoDados clsDados = new AcessoDados();
            StringBuilder stbSQL = new StringBuilder();
        ...
        #region " ObterTempArquivador "

        public DataSet ObterTempArquivador(string strNSU)
        {
            // Classes e variaveis utilizadas
            AcessoDados clsDados = new AcessoDados();
            StringBuilder stbSQL = new StringBuilder();
            ...
            try
            {
                ...
                stbSQL.Append(clsFacil.MontarQuery("  dtc_atualizacao "));
                stbSQL.Append(clsFacil.MontarQuery("FROM "));
                stbSQL.Append(clsFacil.MontarQuery("  cte.tmp_documento_conhecimento_transporte_eletronico WITH (READPAST) "));
                stbSQL.Append(clsFacil.MontarQuery("WHERE "));
                stbSQL.Append(clsFacil.MontarQuery("  num_sequencial_unico = @num_sequencial_unico "));
                string strSQL = stbSQL.ToString();
        ...
        #region " ObterTempArquivadorTop "

        public DataSet ObterTempArquivadorTop(int intTop)
        {
            // Classes e variaveis utilizadas
            AcessoDados clsDados = new AcessoDados();
            StringBuilder stbSQL = new StringBuilder();
        ...
        #region " EnviarFilaArquivador "

        public int EnviarFilaArquivador(string strChave)
        {
            // Classes e variaveis utilizadas
            AcessoDados clsDados = new AcessoDados();
            StringBuilder stbSQL = new StringBuilder();
            ...
            try
            {
                ...
                stbSQL.Append(clsFacil.MontarQuery("FROM SERVICE servico_iniciador_cte_arquivador "));
                stbSQL.Append(clsFacil.MontarQuery("TO SERVICE N'servico_alvo_cte_arquivador' "));
                stbSQL.Append(clsFacil.MontarQuery("ON CONTRACT  contrato_cte_arquivador "));
                stbSQL.Append(clsFacil.MontarQuery("WITH ENCRYPTION = OFF; "));
                stbSQL.Append(clsFacil.MontarQuery("SEND ON CONVERSATION @IdDialogo "));
                stbSQL.Append(clsFacil.MontarQuery("MESSAGE TYPE tipo_mensagem_cte_arquivador (@chave); "));
                string strSQL = stbSQL.ToString();
        ...
        #region " RetirarFilaArquivador "

        public string RetirarFilaArquivador()
        {
            // Classes e variaveis utilizadas
            AcessoDados clsDados = new AcessoDados();
            StringBuilder stbSQL = new StringBuilder();
            ...
            try
            {
                ...
                stbSQL.Append(clsFacil.MontarQuery("FROM "));
                stbSQL.Append(clsFacil.MontarQuery("  fila_alvo_cte_arquivador; "));
        ...
        #region " ObterQtdeFilaArquivador "

        public long ObterQtdeFilaArquivador()
        {
            // Classes e variaveis utilizadas
            AcessoDados clsDados = new AcessoDados();
            StringBuilder stbSQL = new StringBuilder();
            ...
            try
            {
                ...
                stbSQL.Append(clsFacil.MontarQuery("FROM "));
                stbSQL.Append(clsFacil.MontarQuery("  fila_alvo_cte_arquivador WITH (READPAST) "));
                string strSQL = stbSQL.ToString();
