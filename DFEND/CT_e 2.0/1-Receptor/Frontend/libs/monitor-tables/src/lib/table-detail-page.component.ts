...
import { MonitorApiService, ReceptorMonitorStore } from '@receptor/monitor-core';
import { TableDetailDto } from '@receptor/shared-data';
import {
...
export class TablesHubPageComponent {
  private readonly store = inject(ReceptorMonitorStore);
  ...
  template: `
    <section class="flex flex-col gap-4">
      <header class="flex flex-wrap items-end justify-between gap-3">
        <div>
          <a routerLink="/tabelas" class="text-xs text-cyan-400 hover:underline">← Tabelas</a>
