      ...
      <div class="anatomy-poster-head flex shrink-0 flex-wrap items-center justify-between gap-2 px-4 pt-3">
        <div class="min-w-0">
          <p class="text-[10px] font-semibold uppercase tracking-[0.16em] text-amber-300/90">
            Pipeline interno do Arquivador
          </p>
          <h2
...
export class ArquivadorAnatomyFlowComponent implements OnDestroy {
  ...
  readonly caption = input('Ligue o Arquivador para ver o fluxo.');
  ...
  readonly steps: {
  ...
  }[] = [
    {
      ...
      tag: 'Entrada',
      blurb: 'Retira o NSU da fila de entrada.',
    ...
    },
    {
      ...
      title: 'Temp Recepção',
      tag: 'Leitura',
      blurb: 'Obtém o dado na temporária.',
    ...
    },
    {
      ...
      title: 'Sintetizador',
      tag: 'Encaminha',
      blurb: 'Envia para a fila do sintetizador.',
    ...
    },
    {
      ...
      title: 'Analisador',
      tag: 'Análise',
      blurb: 'Analisa o documento do lote.',
