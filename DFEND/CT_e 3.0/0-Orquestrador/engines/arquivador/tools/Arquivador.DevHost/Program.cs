...
namespace Arquivador.DevHost
{
    /// <summary>
    /// Host POC do Monitor — NÃO faz parte do Windows Service original.
    /// Reutiliza ServWindows.StartDebug() já existente no DFEND_CTe_Arquivador
    ...
    internal static class Program
    {
        private static void Main(string[] args)
        {
            ...
            WriteLive("DEVHOST", "Arquivador.DevHost iniciando (host POC do monitor)");
        ...
        private static void InstallLiveTrace(string livePath)
        {
            try
            {
                ...
                // Debug.WriteLine do DFEND_CTe_Arquivador (Threads.cs) cai aqui
