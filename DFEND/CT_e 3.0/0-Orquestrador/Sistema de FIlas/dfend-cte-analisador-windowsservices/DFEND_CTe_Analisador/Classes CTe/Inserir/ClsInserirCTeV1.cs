...
namespace DFe
{
    class ClsInserirCTeV1
    {

        #region "Insert CTe"

        public string InserirXML_detalhe_xml_conhecimento_transporte_eletronico_autorizado(Common.SerializableClasses.CTe.ClsCTe_v1.proc CTe)
        {
        ...
        public string InserirXML_detalhe_xml_conhecimento_transporte_eletronico_fluxo_carga(Common.SerializableClasses.CTe.ClsCTe_v1.proc CTe)
        {
            // Classes e variaveis utilizadas
            AcessoDados clsDados = new AcessoDados();
            Facilitador clsFacil = new Facilitador();
        ...
        public string InserirXML_detalhe_xml_conhecimento_transporte_eletronico_informacao_contribuinte(Common.SerializableClasses.CTe.ClsCTe_v1.proc CTe)
        {
            // Classes e variaveis utilizadas
            AcessoDados clsDados = new AcessoDados();
            Facilitador clsFacil = new Facilitador();
        ...
        public string InserirXML_detalhe_xml_conhecimento_transporte_eletronico_informacao_fisco(Common.SerializableClasses.CTe.ClsCTe_v1.proc CTe)
        {
            // Classes e variaveis utilizadas
            AcessoDados clsDados = new AcessoDados();
            Facilitador clsFacil = new Facilitador();
        ...
        public string InserirXML_detalhe_xml_conhecimento_transporte_eletronico_componente_prestacao(Common.SerializableClasses.CTe.ClsCTe_v1.proc CTe)
        {
            // Classes e variaveis utilizadas
            AcessoDados clsDados = new AcessoDados();
            Facilitador clsFacil = new Facilitador();
        ...
        public string InserirXML_detalhe_xml_conhecimento_transporte_eletronico_carga(Common.SerializableClasses.CTe.ClsCTe_v1.proc CTe)
        {
            // Classes e variaveis utilizadas
            AcessoDados clsDados = new AcessoDados();
            Facilitador clsFacil = new Facilitador();
        ...
        public string InserirXML_detalhe_xml_conhecimento_transporte_eletronico_nota_fiscal(Common.SerializableClasses.CTe.ClsCTe_v1.proc CTe)
        {
            // Classes e variaveis utilizadas
            AcessoDados clsDados = new AcessoDados();
            Facilitador clsFacil = new Facilitador();
            ...
            try
            {
                ...
                int Lcont = 0;
                for (Lcont = 0; Lcont <= CTe.CteProc.CTe.infCte.rem.infNF.Count - 1; Lcont++)
                {
                    strSQL_aux = string.Empty;
                    stbSQL.Clear();
                    // Montando query a ser executada
                    ...
                    clsFacil.AdicionarParametro(ref strSQL_aux, CTe.CteProc.CTe.infCte.rem.infNF[Lcont].nRoma, "@num_romaneio_nota_fiscal", SqlDbType.VarChar);
                    clsFacil.AdicionarParametro(ref strSQL_aux, CTe.CteProc.CTe.infCte.rem.infNF[Lcont].nPed, "@num_pedido_nota_fiscal", SqlDbType.VarChar);
                    clsFacil.AdicionarParametro(ref strSQL_aux, CTe.CteProc.CTe.infCte.rem.infNF[Lcont].mod, "@cod_modelo_nota_fiscal", SqlDbType.SmallInt);
                    clsFacil.AdicionarParametro(ref strSQL_aux, CTe.CteProc.CTe.infCte.rem.infNF[Lcont].serie, "@num_serie_nota_fiscal", SqlDbType.VarChar);
                    clsFacil.AdicionarParametro(ref strSQL_aux, CTe.CteProc.CTe.infCte.rem.infNF[Lcont].nDoc, "@num_nota_fiscal", SqlDbType.VarChar);
                    clsFacil.AdicionarParametro(ref strSQL_aux, Convert.ToString(CTe.CteProc.CTe.infCte.rem.infNF[Lcont].dEmi), "@dtc_emissao_nota_fiscal", SqlDbType.VarChar);
                    clsFacil.AdicionarParametro(ref strSQL_aux, Convert.ToString(CTe.CteProc.CTe.infCte.rem.infNF[Lcont].vBC), "@val_base_calculo", SqlDbType.Decimal);
                    clsFacil.AdicionarParametro(ref strSQL_aux, Convert.ToString(CTe.CteProc.CTe.infCte.rem.infNF[Lcont].vICMS), "@val_total_icms_base_calculo", SqlDbType.Decimal);
                    clsFacil.AdicionarParametro(ref strSQL_aux, Convert.ToString(CTe.CteProc.CTe.infCte.rem.infNF[Lcont].vBCST), "@val_st_base_calculo", SqlDbType.Decimal);
                    clsFacil.AdicionarParametro(ref strSQL_aux, Convert.ToString(CTe.CteProc.CTe.infCte.rem.infNF[Lcont].vST), "@val_total_st", SqlDbType.Decimal);
                    clsFacil.AdicionarParametro(ref strSQL_aux, Convert.ToString(CTe.CteProc.CTe.infCte.rem.infNF[Lcont].vProd), "@val_total_produto", SqlDbType.Decimal);
                    clsFacil.AdicionarParametro(ref strSQL_aux, Convert.ToString(CTe.CteProc.CTe.infCte.rem.infNF[Lcont].vNF), "@val_total_nota_fiscal", SqlDbType.Decimal);
                    clsFacil.AdicionarParametro(ref strSQL_aux, CTe.CteProc.CTe.infCte.rem.infNF[Lcont].nCFOP, "@cod_cfop_predominante", SqlDbType.SmallInt);
                    clsFacil.AdicionarParametro(ref strSQL_aux, Convert.ToString(CTe.CteProc.CTe.infCte.rem.infNF[Lcont].nPeso), "@val_total_peso", SqlDbType.Decimal);
                    clsFacil.AdicionarParametro(ref strSQL_aux, CTe.CteProc.CTe.infCte.rem.infNF[Lcont].PIN, "@num_pin_suframa", SqlDbType.VarChar);                    
                    strSQL = strSQL + strSQL_aux;
                }
        ...
        public string InserirXML_detalhe_xml_conhecimento_transporte_eletronico_nota_fiscal_eletronica(Common.SerializableClasses.CTe.ClsCTe_v1.proc CTe)
        {
            // Classes e variaveis utilizadas
            AcessoDados clsDados = new AcessoDados();
            Facilitador clsFacil = new Facilitador();
            ...
            try
            {
                ...
                int Lcont = 0;
                for (Lcont = 0; Lcont <= CTe.CteProc.CTe.infCte.rem.infNFe.Count - 1; Lcont++)
                {
                    strSQL_aux = string.Empty;
                    stbSQL.Clear();
                    // Montando query a ser executada
                    ...
                    clsFacil.AdicionarParametro(ref strSQL_aux, "20" + CTe.CteProc.protCTe.InfProt.chCTe.Substring(2, 4), "@dtr_referencia", SqlDbType.Int);
                    clsFacil.AdicionarParametro(ref strSQL_aux, CTe.CteProc.protCTe.InfProt.chCTe, "@cod_chave_acesso", SqlDbType.VarChar);
                    clsFacil.AdicionarParametro(ref strSQL_aux, CTe.CteProc.CTe.infCte.rem.infNFe[Lcont].chave, "@cod_chave_acesso_nota_fiscal_eletronica", SqlDbType.VarChar);
                    clsFacil.AdicionarParametro(ref strSQL_aux, CTe.CteProc.CTe.infCte.rem.infNFe[Lcont].PIN, "@num_pin_suframa", SqlDbType.VarChar);                    
        ...
        public string InserirXML_detalhe_xml_conhecimento_transporte_eletronico_outro_documento(Common.SerializableClasses.CTe.ClsCTe_v1.proc CTe)
        {
            // Classes e variaveis utilizadas
            AcessoDados clsDados = new AcessoDados();
            Facilitador clsFacil = new Facilitador();
            ...
            try
            {
                ...
                for (Lcont = 0; Lcont <= CTe.CteProc.CTe.infCte.rem.infNFe.Count - 1; Lcont++)
                {
                    ...
                    clsFacil.AdicionarParametro(ref strSQL_aux, CTe.CteProc.CTe.infCte.rem.infOutros[Lcont].tpDoc, "@cod_tipo_documento_originario", SqlDbType.VarChar);
                    clsFacil.AdicionarParametro(ref strSQL_aux, CTe.CteProc.CTe.infCte.rem.infOutros[Lcont].descOutros, "@des_documento", SqlDbType.VarChar);
                    clsFacil.AdicionarParametro(ref strSQL_aux, CTe.CteProc.CTe.infCte.rem.infOutros[Lcont].nDoc, "@num_documento", SqlDbType.VarChar);
                    clsFacil.AdicionarParametro(ref strSQL_aux, CTe.CteProc.CTe.infCte.rem.infOutros[Lcont].dEmi, "@dtc_emissao", SqlDbType.VarChar);
                    clsFacil.AdicionarParametro(ref strSQL_aux, Convert.ToString(CTe.CteProc.CTe.infCte.rem.infOutros[Lcont].vDocFisc), "@val_documento", SqlDbType.Decimal);                    
        ...
        public string InserirXML_detalhe_xml_conhecimento_transporte_eletronico_transporte_emissor_anterior(Common.SerializableClasses.CTe.ClsCTe_v1.proc CTe)
        {
            // Classes e variaveis utilizadas
            AcessoDados clsDados = new AcessoDados();
            Facilitador clsFacil = new Facilitador();
        ...
        public string InserirXML_detalhe_xml_conhecimento_transporte_eletronico_transporte_anterior_papel(Common.SerializableClasses.CTe.ClsCTe_v1.proc CTe)
        {
            // Classes e variaveis utilizadas
            AcessoDados clsDados = new AcessoDados();
            Facilitador clsFacil = new Facilitador();
        ...
        public string InserirXML_detalhe_xml_conhecimento_transporte_eletronico_transporte_anterior_eletronico(Common.SerializableClasses.CTe.ClsCTe_v1.proc CTe)
        {
            // Classes e variaveis utilizadas
            AcessoDados clsDados = new AcessoDados();
            Facilitador clsFacil = new Facilitador();
        ...
        public string InserirXML_detalhe_xml_conhecimento_transporte_eletronico_veiculo(Common.SerializableClasses.CTe.ClsCTe_v1.proc CTe)
        {
            // Classes e variaveis utilizadas
            AcessoDados clsDados = new AcessoDados();
            Facilitador clsFacil = new Facilitador();
        ...
        public string InserirXML_detalhe_xml_conhecimento_transporte_eletronico_cobranca_duplicata(Common.SerializableClasses.CTe.ClsCTe_v1.proc CTe)
        {
            // Classes e variaveis utilizadas
            AcessoDados clsDados = new AcessoDados();
            Facilitador clsFacil = new Facilitador();
        ...
        public string InserirXML_detalhe_xml_conhecimento_transporte_eletronico_complementado(Common.SerializableClasses.CTe.ClsCTe_v1.proc CTe)
        {
            // Classes e variaveis utilizadas
            AcessoDados clsDados = new AcessoDados();
            Facilitador clsFacil = new Facilitador();
        ...
        public string InserirXML_detalhe_xml_conhecimento_transporte_eletronico_modal_rodoviario(Common.SerializableClasses.CTe.ClsCTe_v1.proc CTe)
        {
            // Classes e variaveis utilizadas
            AcessoDados clsDados = new AcessoDados();
            Facilitador clsFacil = new Facilitador();
        ...
        public string InserirXML_detalhe_xml_conhecimento_transporte_eletronico_modal_aereo(Common.SerializableClasses.CTe.ClsCTe_v1.proc CTe)
        {
            // Classes e variaveis utilizadas
            AcessoDados clsDados = new AcessoDados();
            Facilitador clsFacil = new Facilitador();
        ...
        public string InserirXML_detalhe_xml_conhecimento_transporte_eletronico_modal_aereo_natureza_carga(Common.SerializableClasses.CTe.ClsCTe_v1.proc CTe)
        {
            // Classes e variaveis utilizadas
            AcessoDados clsDados = new AcessoDados();
            Facilitador clsFacil = new Facilitador();
        ...
        public string InserirXML_detalhe_xml_conhecimento_transporte_eletronico_modal_ferroviario(Common.SerializableClasses.CTe.ClsCTe_v1.proc CTe)
        {
            // Classes e variaveis utilizadas
            AcessoDados clsDados = new AcessoDados();
            Facilitador clsFacil = new Facilitador();
        ...
        public string InserirXML_detalhe_xml_conhecimento_transporte_eletronico_modal_ferroviario_ferrovia(Common.SerializableClasses.CTe.ClsCTe_v1.proc CTe)
        {
            // Classes e variaveis utilizadas
            AcessoDados clsDados = new AcessoDados();
            Facilitador clsFacil = new Facilitador();
        ...
        public string InserirXML_detalhe_xml_conhecimento_transporte_eletronico_modal_dutoviario(Common.SerializableClasses.CTe.ClsCTe_v1.proc CTe)
        {
            // Classes e variaveis utilizadas
            AcessoDados clsDados = new AcessoDados();
            Facilitador clsFacil = new Facilitador();
        ...
        public string InserirXML_detalhe_xml_conhecimento_transporte_eletronico_modal_aquaviario(Common.SerializableClasses.CTe.ClsCTe_v1.proc CTe)
        {
            // Classes e variaveis utilizadas
            AcessoDados clsDados = new AcessoDados();
            Facilitador clsFacil = new Facilitador();
        ...
        public string InserirXML_detalhe_xml_conhecimento_transporte_eletronico_modal_aquaviario_balsa(Common.SerializableClasses.CTe.ClsCTe_v1.proc CTe)
        {
            // Classes e variaveis utilizadas
            AcessoDados clsDados = new AcessoDados();
            Facilitador clsFacil = new Facilitador();
        ...
        public string InserirXML_detalhe_xml_conhecimento_transporte_eletronico_modal_aquaviario_conteiner(Common.SerializableClasses.CTe.ClsCTe_v1.proc CTe)
        {
            // Classes e variaveis utilizadas
            AcessoDados clsDados = new AcessoDados();
            Facilitador clsFacil = new Facilitador();
        ...
        public string InserirXML_detalhe_xml_conhecimento_transporte_eletronico_modal_aquaviario_conteiner_lacre(Common.SerializableClasses.CTe.ClsCTe_v1.proc CTe)
        {
            // Classes e variaveis utilizadas
            AcessoDados clsDados = new AcessoDados();
            Facilitador clsFacil = new Facilitador();
        ...
        public string InserirXML_detalhe_xml_conhecimento_transporte_eletronico_modal_aquaviario_nota_fiscal(Common.SerializableClasses.CTe.ClsCTe_v1.proc CTe)
        {
            // Classes e variaveis utilizadas
            AcessoDados clsDados = new AcessoDados();
            Facilitador clsFacil = new Facilitador();
        ...
        public string InserirXML_detalhe_xml_conhecimento_transporte_eletronico_modal_aquaviario_nota_fiscal_eletronica(Common.SerializableClasses.CTe.ClsCTe_v1.proc CTe)
        {
            // Classes e variaveis utilizadas
            AcessoDados clsDados = new AcessoDados();
            Facilitador clsFacil = new Facilitador();
