...
import { LogEntry } from '@integrador/shared-data';
import {
  LogKind,
  classifyLogKind,
  logKindLabel,
      ...
      <header class="flex flex-wrap items-end justify-between gap-3">
        <div>
          ...
          <p class="text-sm text-zinc-400">
            Linha do tempo completa do que o Integrador fez no banco.
            @if (store.live()) {
        ...
        <div class="space-y-0">
          @for (l of visibleNewestFirst(); track l.seqLog; let i = $index) {
            ...
            <p class="p-6 text-center text-zinc-500">
              Nenhum evento neste filtro. Tente “Todos” ou ligue o Integrador.
            </p>
          }
        </div>
      </div>
