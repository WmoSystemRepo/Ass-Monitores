...
@Component({
  ...
  standalone: true,
  imports: [DatePipe, SintetizadorAnatomyFlowComponent, TableHealthCardsComponent],
  ...
  template: `
    <section class="dashboard-fit flex h-full max-h-full flex-col gap-1.5 overflow-hidden">
      ...
      >
        ...
        <span class="inline-flex items-baseline gap-1.5">
          <span class="text-zinc-500">Síntese</span>
          <span
            class="font-medium"
...
export class SintetizadorDashboardPageComponent {
  ...
  readonly statusLabel = computed(() =>
    sintetizadorStatusLabel(this.service()?.scmStatus, this.service()?.executar)
  );
