...
import { RecentDocument } from '@integrador/shared-data';
...
export class AnatomyFlowComponent implements OnDestroy {
  ...
  readonly caption = input('Ligue o Integrador para ver o fluxo.');
  ...
  readonly steps: {
    ...
    },
    {
      ...
      title: 'Temporária',
      tag: 'Leitura',
      blurb: 'Obtém o lote em tmp_integrador.',
