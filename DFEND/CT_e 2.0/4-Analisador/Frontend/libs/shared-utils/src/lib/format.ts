...
/** Conexão SignalR do monitor (não confundir com Analisador ligado). */
...
export function analisadorStatusLabel(scmStatus?: string | null, executar?: number | null): string {
