...
public class AlertEngineTests
{
    ...
    {
        var service = new ServiceStatusView("DFEND_CTe_Integrador", "Running", true, 0, "DEV", DateTimeOffset.UtcNow, "Integrador");
    ...
    {
        var service = new ServiceStatusView("DFEND_CTe_Integrador", "Stopped", false, 0, null, null, null);
        var alerts = AlertEngine.Evaluate(
            service,
            new QueueStats(0, 0, null, Array.Empty<long>()),
            Array.Empty<RecentDocument>(),
    ...
    {
        var service = new ServiceStatusView("DFEND_CTe_Integrador", "Running", true, 1, "DEV", DateTimeOffset.UtcNow, "Integrador");
        var logs = new[]
        {
