    ...
    >
      <header class="flex shrink-0 flex-wrap items-center justify-between gap-2">
        ...
        <div class="flex flex-wrap items-center gap-3">
          <a routerLink="/logs" class="text-xs text-teal-400 hover:underline">Histórico →</a>
          <a routerLink="/" class="text-xs text-teal-400 hover:underline">← Voltar ao Monitor</a>
        </div>
      </header>
        ...
        >
          <div class="mb-1.5 flex shrink-0 flex-wrap items-center justify-between gap-2">
            ...
            <div class="flex flex-wrap gap-2">
              <a routerLink="/config" class="text-[10px] text-teal-400 hover:underline"
                >Config →</a
              >
            </div>
          </div>
