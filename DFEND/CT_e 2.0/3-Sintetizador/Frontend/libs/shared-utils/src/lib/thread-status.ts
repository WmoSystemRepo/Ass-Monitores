...
export interface ThreadStatusInput {
  ...
  executar: number;
  /** Processo Sintetizador em execução (SCM/DevHost). */
...
/**
 * Status específico da linha — usar só com Sintetizador ligado.
