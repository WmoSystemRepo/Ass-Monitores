...
namespace Integrador.DevHost
{
    /// <summary>
    /// Host POC do Monitor — NÃO faz parte do Windows Service original.
    /// Reutiliza ServWindows.StartDebug() já existente no DFEND_CTe_Integrador
    /// (o mesmo caminho usado quando o depurador está anexado), sem alterar o fonte original.
    ///
    /// Captura Debug.WriteLine do Integrador em monitor-live.log
    ...
    internal static class Program
    {
        private static void Main(string[] args)
        {
            ...
            WriteLive("DEVHOST", "Integrador.DevHost iniciando (host POC do monitor)");
        ...
        private static void InstallLiveTrace(string livePath)
        {
            try
            {
                ...
                // Debug.WriteLine do DFEND_CTe_Integrador (Threads.cs) cai aqui
