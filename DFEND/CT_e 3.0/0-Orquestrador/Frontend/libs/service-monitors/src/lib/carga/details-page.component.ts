...
@Component({
  selector: 'lib-carga-details-page',
  standalone: true,
    ...
    >
      <header class="flex shrink-0 flex-wrap items-center justify-between gap-2">
        ...
        <div class="flex flex-wrap items-center gap-3">
          <a routerLink="/monitores/carga/logs" class="text-xs text-teal-400 hover:underline">Histórico →</a>
          <a routerLink="/monitores/carga" class="text-xs text-teal-400 hover:underline">← Voltar ao Monitor</a>
        </div>
      </header>
      ...
      <div class="grid min-h-0 flex-1 grid-cols-1 gap-2 lg:grid-cols-2">
        ...
        >
          <div class="mb-1.5 shrink-0">
            <h2 class="text-sm font-medium text-zinc-200">Passos do Carga · online</h2>
            ...
            @for (row of flowFeed(); track row.key) {
              <div class="flex gap-2 text-[11px] leading-snug text-zinc-400">
                ...
                <span
                  ...
                  [class.bg-teal-950]="row.kind === 'debug'"
                  [class.text-teal-300]="row.kind === 'debug'"
              ...
              <p class="text-xs text-zinc-500">
                Sem passos Debug/SQL. Ligue o Carga pelo Monitor.
              </p>
            }
          </div>
        </section>
        ...
        >
          <div class="mb-1.5 shrink-0">
            <h2 class="text-sm font-medium text-zinc-200">Últimos eventos SQL do Carga</h2>
        ...
        >
          <div class="mb-1.5 flex shrink-0 flex-wrap items-center justify-between gap-2">
            <div>
              <h2 class="text-sm font-medium text-zinc-200">Carga · parâmetros e lotes</h2>
              <p class="text-[10px] text-zinc-500">Configuração ativa e CT-e recentes na temporária</p>
            </div>
            <div class="flex flex-wrap gap-2">
              <a routerLink="/monitores/carga/config" class="text-[10px] text-teal-400 hover:underline"
                >Config →</a
              >
            </div>
          </div>
...
export class CargaDetailsPageComponent {
