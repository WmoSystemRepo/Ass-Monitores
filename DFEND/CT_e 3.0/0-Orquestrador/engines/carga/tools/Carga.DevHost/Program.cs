...
namespace Carga.DevHost
{
    ...
    internal static class Program
    {
        private static void Main(string[] args)
        {
            ...
            WriteLive("DEVHOST", "Carga.DevHost iniciando (host POC do monitor)");
