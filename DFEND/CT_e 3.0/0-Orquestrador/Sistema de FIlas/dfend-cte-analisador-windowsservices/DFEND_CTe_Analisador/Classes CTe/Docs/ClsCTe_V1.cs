...
{
    //Ultima atualização: PL_CTe_104c_NT2013.004
    public class ClsCTe_v1
    {
...

        {
            ...
            [XmlElement(ElementName = "contQt")]
            public List<contQt> contQt { get; set; }
        ...
        public class contQt
        {
            public contQt()
            {
                lacContQt = new List<lacContQt>();
            }
            public string nCont { get; set; }

            [XmlElement(ElementName = "lacContQt")]
            public List<lacContQt> lacContQt { get; set; }
        ...
        public class infCteComp
        {
            public infCteComp()
            {
                vPresComp = new vPresComp();
                impComp = new impComp();
            }

            public string chave { get; set; }

            public vPresComp vPresComp { get; set; }

            public impComp impComp { get; set; }
        ...
        public class vPresComp
        {
            public vPresComp()
            {
                compComp = new List<compComp>();

            }
            public decimal? vTPrest { get; set; }

            [XmlElement(ElementName = "compComp")]
            public List<compComp> compComp { get; set; }
        }
        ...
        public class impComp
        {
            public impComp()
            {
                ICMSComp = new ICMSComp();
            }
            public ICMSComp ICMSComp { get; set; }
            public decimal? vTotTrib { get; set; }
            public string infAdFisco { get; set; }
