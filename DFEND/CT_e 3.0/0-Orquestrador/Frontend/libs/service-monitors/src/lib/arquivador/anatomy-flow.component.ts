...
@Component({
  selector: 'lib-arquivador-anatomy-flow',
  standalone: true,
    ...
    >
      <div class="anatomy-poster-head flex shrink-0 flex-wrap items-center justify-between gap-2 px-4 pt-3">
        <div class="min-w-0">
          ...
          <h2
            ...
            title="DFEND_CTe_Arquivador — ciclo fila → temp → sintetizador → analisador → integrador"
          >
            Caminho do CT-e no Arquivador
          </h2>
        ...
        <div class="flex flex-wrap items-center gap-2">
          @if (latest(); as lote) {
            <div class="rounded-lg border border-zinc-600/70 bg-zinc-900/70 px-3 py-1.5 shadow-sm">
              <p class="text-[9px] font-semibold uppercase tracking-wide text-amber-400">Último lote</p>
          ...
          <a
            ...
            class="rounded border border-zinc-600 bg-zinc-900/60 px-2.5 py-1 text-[11px] font-medium text-amber-300 hover:bg-zinc-800"
          >
            Mais informações →
          </a>
        </div>
      ...
      @if (beltMoving()) {
        ...
        <p
          ...
          title="Aguardando próximo ciclo de arquivamento"
        >
          Nenhum documento passando agora — o Arquivador processa a fila de tempos em tempos
        </p>
      }
        ...
        <div class="anatomy-fill-board relative flex h-full min-w-[880px] flex-col items-stretch px-2 py-2">
          <div class="anatomy-cycle-block relative z-[1] mx-auto w-full">
            ...
            <div class="anatomy-summary-bar mt-3 shrink-0">
              ...
              <div title="Threads">
                <a
                  routerLink="/monitores/arquivador/threads"
                  class="anatomy-summary-label hover:text-amber-300"
...
export class ArquivadorAnatomyFlowComponent implements OnDestroy {
  readonly store = inject(ServiceMonitorStore);

  readonly running = input(false);
  readonly activeStage = input<AnatomyStage | null>(null);
  readonly caption = input(
    'Use Ligar o fluxo no topo para o Arquivador começar a processar a fila.'
  );
  ...
  readonly steps: {
    ...
    {
      id: 'fila',
      title: 'Fila Arquivador',
      tag: 'Entrada',
      blurb: 'Pega o CT-e que chegou na fila.',
      techHint: 'Fila de entrada · RECEIVE / retirar da fila',
    },
    {
      id: 'temp',
      title: 'Temp Recepção',
      ...
      techHint: 'Temporária de recepção · obter temp',
    },
    {
      id: 'sintetizador',
      title: 'Sintetizador',
      tag: 'Encaminha',
      blurb: 'Avisa o Sintetizador.',
      techHint: 'Fila sintetizador',
    },
    {
      id: 'analisador',
      title: 'Analisador',
      tag: 'Análise',
      blurb: 'Segue para análise do lote.',
      techHint: 'Analisador do ciclo de arquivamento',
    },
    {
      id: 'integrador',
      title: 'Integrador',
      tag: 'Próximo',
      blurb: 'Integra e limpa o temporário.',
      techHint: 'Integrador · excluir temp',
    },
  ];
