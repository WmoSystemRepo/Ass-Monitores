...
namespace Analisador.DevHost
{
    /// <summary>
    /// Host POC do Monitor — NÃO faz parte do Windows Service original.
    /// Reutiliza ServWindows.StartDebug() já existente no DFEND_CTe_Analisador
    /// (o mesmo caminho usado quando o depurador está anexado), sem alterar o fonte original.
    ///
    /// Captura Debug.WriteLine do Analisador em monitor-live.log
    ...
    internal static class Program
    {
        private static void Main(string[] args)
        {
            ...
            WriteLive("DEVHOST", "Analisador.DevHost iniciando (host POC do monitor)");
